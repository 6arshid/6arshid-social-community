...
define( 'ARSHID6SOCIAL_TEXT_DOMAIN', '6arshid-social-community-main' );
		...
		function () {
			printf(
				...
				sprintf(
					...
					esc_html__( '6Arshid Social Community requires PHP %1$s or higher. You are running PHP %2$s. Please upgrade.', '6arshid-social-community-main' ),
