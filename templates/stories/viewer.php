...
<div class="sn-story-viewer" id="sn-story-viewer" role="dialog" aria-modal="true"
     aria-label="<?php esc_attr_e( 'Story Viewer', '6arshid-social-community' ); ?>" hidden>
	...
	<header class="sn-story-viewer__header">
		...
		<div class="sn-story-viewer__header-actions">
			...
			<button class="sn-story-viewer__btn sn-story-mute-btn"
			        ...
			        aria-label="<?php esc_attr_e( 'Mute stories', '6arshid-social-community' ); ?>"
			        title="<?php esc_attr_e( 'Mute', '6arshid-social-community' ); ?>"
			        hidden>
			...
			<button class="sn-story-viewer__btn sn-story-report-btn"
			        ...
			        aria-label="<?php esc_attr_e( 'Report story', '6arshid-social-community' ); ?>"
			        title="<?php esc_attr_e( 'Report', '6arshid-social-community' ); ?>">
				<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
			...
			<button class="sn-story-viewer__btn sn-story-delete-btn"
			        ...
			        aria-label="<?php esc_attr_e( 'Delete story', '6arshid-social-community' ); ?>"
			        title="<?php esc_attr_e( 'Delete', '6arshid-social-community' ); ?>"
			        hidden>
				<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
			...
			<button class="sn-story-viewer__btn sn-story-highlight-btn"
			        ...
			        aria-label="<?php esc_attr_e( 'Add to Highlights', '6arshid-social-community' ); ?>"
			        title="<?php esc_attr_e( 'Add to Highlights', '6arshid-social-community' ); ?>"
			        hidden>
				<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
	...
	<button class="sn-story-viewer__nav sn-story-viewer__nav--prev" id="sn-story-prev"
	        aria-label="<?php esc_attr_e( 'Previous', '6arshid-social-community' ); ?>">
		<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
	...
	<button class="sn-story-viewer__nav sn-story-viewer__nav--next" id="sn-story-next"
	        aria-label="<?php esc_attr_e( 'Next', '6arshid-social-community' ); ?>">
		<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
	...
	<footer class="sn-story-viewer__footer">
		<button class="sn-story-viewer__viewers-btn" id="sn-story-viewers-btn" hidden
		        aria-label="<?php esc_attr_e( 'View viewers', '6arshid-social-community' ); ?>">
		...
		<div class="sn-story-viewer__reactions" id="sn-story-reactions" role="toolbar"
		     aria-label="<?php esc_attr_e( 'React to story', '6arshid-social-community' ); ?>">
		...
		<div class="sn-story-viewer__reply" id="sn-story-reply-wrap">
			<input type="text" class="sn-story-viewer__reply-input" id="sn-story-reply-input"
			       placeholder="<?php esc_attr_e( 'Reply to story…', '6arshid-social-community' ); ?>"
			       maxlength="500" autocomplete="off">
			<button class="sn-story-viewer__reply-send" id="sn-story-reply-send"
			        aria-label="<?php esc_attr_e( 'Send reply', '6arshid-social-community' ); ?>">
