...
?>
<div class="sn-stories-bottom-bar" id="sn-stories-bottom-bar" aria-label="<?php esc_attr_e( 'Stories', 'social-network-6' ); ?>">
	<div class="sn-stories-bottom-bar__inner" role="list">
		...
		<div class="sn-story-bubble sn-story-bubble--own" role="listitem">
			<button class="sn-story-bubble__avatar-btn" id="sn-add-story-btn-bar"
			        aria-label="<?php esc_attr_e( 'Add Story', 'social-network-6' ); ?>">
			...
			<span class="sn-story-bubble__name"><?php esc_html_e( 'Your Story', 'social-network-6' ); ?></span>
		</div>
		<?php endif; ?>
		...
		<div class="sn-story-bubble<?php echo $is_own ? ' sn-story-bubble--own' : ''; ?>"
			...
			<button class="sn-story-bubble__avatar-btn sn-open-story"
			        data-story-id="<?php echo esc_attr( $story->id ); ?>"
			        aria-label="<?php echo esc_attr( sprintf( /* translators: %s: user display name */ __( '%s\'s story', 'social-network-6' ), $story->display_name ) ); ?>">
