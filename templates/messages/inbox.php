...
$_arshid6social_config = array(
	...
	'l10n'     => array(
		'noConversations'   => __( 'No conversations yet. Start one with the + button.', 'social-network-6' ),
		'loading'           => __( 'Loading...', 'social-network-6' ),
		'noUsersFound'      => __( 'No users found.', 'social-network-6' ),
		'couldNotLoadUsers' => __( 'Could not load users.', 'social-network-6' ),
		'loadMore'          => __( 'Load more', 'social-network-6' ),
		'errorPrefix'       => __( 'Error:', 'social-network-6' ),
		'conversation'      => __( 'Conversation', 'social-network-6' ),
		'noMessagesYet'     => __( 'No messages yet. Say hello!', 'social-network-6' ),
		'edited'            => __( 'edited', 'social-network-6' ),
		'edit'              => __( 'Edit', 'social-network-6' ),
		'delete'            => __( 'Delete', 'social-network-6' ),
		'save'              => __( 'Save', 'social-network-6' ),
		'cancel'            => __( 'Cancel', 'social-network-6' ),
		'fileTooLarge'      => sprintf(
			/* translators: %s = max MB */
			__( 'File exceeds %s MB limit.', 'social-network-6' ),
			$_att_max_mb
		),
		'removeAttachment'  => __( 'Remove', 'social-network-6' ),
	),
);
?>
...
>
	<div class="arshid6social-messages-layout" id="arshid6social-messages-layout">
		...
		<!-- Thread list sidebar -->
		<aside class="arshid6social-thread-list" id="arshid6social-thread-list" aria-label="<?php esc_attr_e( 'Conversations', 'social-network-6' ); ?>" role="navigation">
			<div class="arshid6social-thread-list__header">
				<span class="arshid6social-thread-list__title"><?php esc_html_e( 'Messages', 'social-network-6' ); ?></span>
				<button class="arshid6social-compose-btn" id="arshid6social-compose-btn"
					aria-label="<?php esc_attr_e( 'New message', 'social-network-6' ); ?>"
					title="<?php esc_attr_e( 'New message', 'social-network-6' ); ?>">+</button>
			</div>
			<div class="arshid6social-thread-search-wrap">
				<input type="search" id="arshid6social-thread-search" class="arshid6social-thread-search"
					placeholder="<?php esc_attr_e( 'Search messages or users…', 'social-network-6' ); ?>"
					autocomplete="off"
					aria-label="<?php esc_attr_e( 'Search conversations', 'social-network-6' ); ?>" />
			</div>
		...
		<!-- Message pane -->
		<main class="arshid6social-message-pane" id="arshid6social-message-pane" aria-label="<?php esc_attr_e( 'Message thread', 'social-network-6' ); ?>">
			<div class="arshid6social-message-pane__header" id="arshid6social-pane-header">
				<button class="arshid6social-back-btn" id="arshid6social-back-btn" aria-label="<?php esc_attr_e( 'Back to conversations', 'social-network-6' ); ?>">
				...
				<span id="arshid6social-pane-title"><?php esc_html_e( 'Select a conversation', 'social-network-6' ); ?></span>
			</div>
			...
			<div class="arshid6social-message-composer" id="arshid6social-message-composer" hidden>
				...
				<div class="arshid6social-composer-row">
					...
					<button type="button" class="arshid6social-attach-btn" id="arshid6social-attach-btn"
						aria-label="<?php esc_attr_e( 'Attach file', 'social-network-6' ); ?>"
						title="<?php esc_attr_e( 'Attach file', 'social-network-6' ); ?>">
					...
					<textarea class="arshid6social-message-composer__input" id="arshid6social-message-input"
						rows="1"
						placeholder="<?php esc_attr_e( 'Type a message…', 'social-network-6' ); ?>"
						aria-label="<?php esc_attr_e( 'Message', 'social-network-6' ); ?>"
					></textarea>
					<button class="arshid6social-btn arshid6social-btn--primary" id="arshid6social-send-btn">
						<?php esc_html_e( 'Send', 'social-network-6' ); ?>
					</button>
				</div>
			</div>
		</main>
	...
	<div class="arshid6social-compose-modal" id="arshid6social-compose-modal" hidden role="dialog" aria-modal="true"
		...
		<div class="arshid6social-compose-modal__inner">
			<div class="arshid6social-compose-modal__header">
				<h3><?php esc_html_e( 'New Message', 'social-network-6' ); ?></h3>
				<button class="arshid6social-compose-close" id="arshid6social-compose-close" aria-label="<?php esc_attr_e( 'Close', 'social-network-6' ); ?>">&#x2715;</button>
			</div>
			<input type="search" class="arshid6social-user-search" id="arshid6social-user-search"
				placeholder="<?php esc_attr_e( 'Search users…', 'social-network-6' ); ?>"
				aria-label="<?php esc_attr_e( 'Search users', 'social-network-6' ); ?>"
				autocomplete="off" />
	...
	<div class="arshid6social-delete-modal" id="arshid6social-delete-confirm-modal" hidden role="dialog" aria-modal="true"
		aria-label="<?php esc_attr_e( 'Delete conversation', 'social-network-6' ); ?>">
		<div class="arshid6social-delete-modal__inner">
			<h3 class="arshid6social-delete-modal__title"><?php esc_html_e( 'Delete Conversation', 'social-network-6' ); ?></h3>
			<p class="arshid6social-delete-modal__desc"><?php esc_html_e( 'Who do you want to delete this conversation for?', 'social-network-6' ); ?></p>
			<div class="arshid6social-delete-modal__actions">
				<button class="arshid6social-btn arshid6social-btn--danger" id="arshid6social-delete-for-both">
					<?php esc_html_e( 'Delete for Everyone', 'social-network-6' ); ?>
				</button>
				<button class="arshid6social-btn arshid6social-btn--secondary" id="arshid6social-delete-for-self">
					<?php esc_html_e( 'Delete for Me Only', 'social-network-6' ); ?>
				</button>
	...
	<div class="arshid6social-delete-modal" id="arshid6social-delete-msg-modal" hidden role="dialog" aria-modal="true"
		aria-label="<?php esc_attr_e( 'Delete message', 'social-network-6' ); ?>">
		<div class="arshid6social-delete-modal__inner">
			<h3 class="arshid6social-delete-modal__title"><?php esc_html_e( 'Delete Message', 'social-network-6' ); ?></h3>
			<p class="arshid6social-delete-modal__desc"><?php esc_html_e( 'Who do you want to delete this message for?', 'social-network-6' ); ?></p>
			<div class="arshid6social-delete-modal__actions">
