...
$_arshid6social_config = array(
	...
	'l10n'     => array(
		'noConversations'   => __( 'No conversations yet. Start one with the + button.', '6arshid-social-community-main' ),
		'loading'           => __( 'Loading...', '6arshid-social-community-main' ),
		'noUsersFound'      => __( 'No users found.', '6arshid-social-community-main' ),
		'couldNotLoadUsers' => __( 'Could not load users.', '6arshid-social-community-main' ),
		'loadMore'          => __( 'Load more', '6arshid-social-community-main' ),
		'errorPrefix'       => __( 'Error:', '6arshid-social-community-main' ),
		'conversation'      => __( 'Conversation', '6arshid-social-community-main' ),
		'noMessagesYet'     => __( 'No messages yet. Say hello!', '6arshid-social-community-main' ),
		'edited'            => __( 'edited', '6arshid-social-community-main' ),
		'edit'              => __( 'Edit', '6arshid-social-community-main' ),
		'delete'            => __( 'Delete', '6arshid-social-community-main' ),
		'save'              => __( 'Save', '6arshid-social-community-main' ),
		'cancel'            => __( 'Cancel', '6arshid-social-community-main' ),
		'fileTooLarge'      => sprintf(
			/* translators: %s = max MB */
			__( 'File exceeds %s MB limit.', '6arshid-social-community-main' ),
			$_att_max_mb
		),
		'removeAttachment'  => __( 'Remove', '6arshid-social-community-main' ),
	),
);
?>
...
>
	<div class="arshid6social-messages-layout" id="arshid6social-messages-layout">
		...
		<!-- Thread list sidebar -->
		<aside class="arshid6social-thread-list" id="arshid6social-thread-list" aria-label="<?php esc_attr_e( 'Conversations', '6arshid-social-community-main' ); ?>" role="navigation">
			<div class="arshid6social-thread-list__header">
				<span class="arshid6social-thread-list__title"><?php esc_html_e( 'Messages', '6arshid-social-community-main' ); ?></span>
				<button class="arshid6social-compose-btn" id="arshid6social-compose-btn"
					aria-label="<?php esc_attr_e( 'New message', '6arshid-social-community-main' ); ?>"
					title="<?php esc_attr_e( 'New message', '6arshid-social-community-main' ); ?>">+</button>
			</div>
			<div class="arshid6social-thread-search-wrap">
				<input type="search" id="arshid6social-thread-search" class="arshid6social-thread-search"
					placeholder="<?php esc_attr_e( 'Search messages or users…', '6arshid-social-community-main' ); ?>"
					autocomplete="off"
					aria-label="<?php esc_attr_e( 'Search conversations', '6arshid-social-community-main' ); ?>" />
			</div>
		...
		<!-- Message pane -->
		<main class="arshid6social-message-pane" id="arshid6social-message-pane" aria-label="<?php esc_attr_e( 'Message thread', '6arshid-social-community-main' ); ?>">
			<div class="arshid6social-message-pane__header" id="arshid6social-pane-header">
				<button class="arshid6social-back-btn" id="arshid6social-back-btn" aria-label="<?php esc_attr_e( 'Back to conversations', '6arshid-social-community-main' ); ?>">
				...
				<span id="arshid6social-pane-title"><?php esc_html_e( 'Select a conversation', '6arshid-social-community-main' ); ?></span>
			</div>
			...
			<div class="arshid6social-message-composer" id="arshid6social-message-composer" hidden>
				...
				<div class="arshid6social-composer-row">
					...
					<button type="button" class="arshid6social-attach-btn" id="arshid6social-attach-btn"
						aria-label="<?php esc_attr_e( 'Attach file', '6arshid-social-community-main' ); ?>"
						title="<?php esc_attr_e( 'Attach file', '6arshid-social-community-main' ); ?>">
					...
					<textarea class="arshid6social-message-composer__input" id="arshid6social-message-input"
						rows="1"
						placeholder="<?php esc_attr_e( 'Type a message…', '6arshid-social-community-main' ); ?>"
						aria-label="<?php esc_attr_e( 'Message', '6arshid-social-community-main' ); ?>"
					></textarea>
					<button class="arshid6social-btn arshid6social-btn--primary" id="arshid6social-send-btn">
						<?php esc_html_e( 'Send', '6arshid-social-community-main' ); ?>
					</button>
				</div>
			</div>
		</main>
	...
	<div class="arshid6social-compose-modal" id="arshid6social-compose-modal" hidden role="dialog" aria-modal="true"
		...
		<div class="arshid6social-compose-modal__inner">
			<div class="arshid6social-compose-modal__header">
				<h3><?php esc_html_e( 'New Message', '6arshid-social-community-main' ); ?></h3>
				<button class="arshid6social-compose-close" id="arshid6social-compose-close" aria-label="<?php esc_attr_e( 'Close', '6arshid-social-community-main' ); ?>">&#x2715;</button>
			</div>
			<input type="search" class="arshid6social-user-search" id="arshid6social-user-search"
				placeholder="<?php esc_attr_e( 'Search users…', '6arshid-social-community-main' ); ?>"
				aria-label="<?php esc_attr_e( 'Search users', '6arshid-social-community-main' ); ?>"
				autocomplete="off" />
	...
	<div class="arshid6social-delete-modal" id="arshid6social-delete-confirm-modal" hidden role="dialog" aria-modal="true"
		aria-label="<?php esc_attr_e( 'Delete conversation', '6arshid-social-community-main' ); ?>">
		<div class="arshid6social-delete-modal__inner">
			<h3 class="arshid6social-delete-modal__title"><?php esc_html_e( 'Delete Conversation', '6arshid-social-community-main' ); ?></h3>
			<p class="arshid6social-delete-modal__desc"><?php esc_html_e( 'Who do you want to delete this conversation for?', '6arshid-social-community-main' ); ?></p>
			<div class="arshid6social-delete-modal__actions">
				<button class="arshid6social-btn arshid6social-btn--danger" id="arshid6social-delete-for-both">
					<?php esc_html_e( 'Delete for Everyone', '6arshid-social-community-main' ); ?>
				</button>
				<button class="arshid6social-btn arshid6social-btn--secondary" id="arshid6social-delete-for-self">
					<?php esc_html_e( 'Delete for Me Only', '6arshid-social-community-main' ); ?>
				</button>
	...
	<div class="arshid6social-delete-modal" id="arshid6social-delete-msg-modal" hidden role="dialog" aria-modal="true"
		aria-label="<?php esc_attr_e( 'Delete message', '6arshid-social-community-main' ); ?>">
		<div class="arshid6social-delete-modal__inner">
			<h3 class="arshid6social-delete-modal__title"><?php esc_html_e( 'Delete Message', '6arshid-social-community-main' ); ?></h3>
			<p class="arshid6social-delete-modal__desc"><?php esc_html_e( 'Who do you want to delete this message for?', '6arshid-social-community-main' ); ?></p>
			<div class="arshid6social-delete-modal__actions">
