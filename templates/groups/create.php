...
<div class="arshid6social-container" style="padding-block:2rem;">
	...
	<div class="arshid6social-create-group-header">
		<a href="<?php echo esc_url( home_url( '/groups/' ) ); ?>" class="arshid6social-breadcrumb-back">
			&larr; <?php esc_html_e( 'Back to Groups', '6arshid-social-community-main' ); ?>
		</a>
		<h1 class="arshid6social-page-title"><?php esc_html_e( 'Create a Group', '6arshid-social-community-main' ); ?></h1>
	</div>
	...
	<div class="arshid6social-create-group-layout">
			...
			<form class="arshid6social-create-group-form" method="post" novalidate>
				...
				<div class="arshid6social-form-group">
					...
					<input type="text" id="arshid6social-group-name" name="name" class="arshid6social-input"
						...
						placeholder="<?php esc_attr_e( 'Enter a name for your group…', '6arshid-social-community-main' ); ?>" />
				</div>
				...
				<div class="arshid6social-form-group">
					...
					<textarea id="arshid6social-group-desc" name="description" class="arshid6social-input"
						...
						placeholder="<?php esc_attr_e( 'What is this group about?', '6arshid-social-community-main' ); ?>"></textarea>
				</div>
				...
				<div class="arshid6social-form-group">
					...
					<select id="arshid6social-group-status" name="status" class="arshid6social-input">
						<option value="public"><?php esc_html_e( 'Public — anyone can join and see posts', '6arshid-social-community-main' ); ?></option>
						<option value="private"><?php esc_html_e( 'Private — anyone can request, but only members see posts', '6arshid-social-community-main' ); ?></option>
						<option value="hidden"><?php esc_html_e( 'Hidden — invite only, not listed in directory', '6arshid-social-community-main' ); ?></option>
					</select>
				</div>
		...
		<aside class="arshid6social-card arshid6social-create-group-tips" style="padding:1.5rem;">
			<h3 style="margin:0 0 1rem;font-size:1rem;font-weight:600;"><?php esc_html_e( 'Privacy Settings', '6arshid-social-community-main' ); ?></h3>
			<ul style="margin:0;padding:0 0 0 1.25rem;display:flex;flex-direction:column;gap:.75rem;color:var(--arshid6social-text-muted);font-size:.875rem;">
				<li>
					<strong style="color:var(--arshid6social-text);"><?php esc_html_e( 'Public', '6arshid-social-community-main' ); ?></strong><br>
					<?php esc_html_e( 'Anyone can find, join, and read posts.', '6arshid-social-community-main' ); ?>
				</li>
				<li>
					<strong style="color:var(--arshid6social-text);"><?php esc_html_e( 'Private', '6arshid-social-community-main' ); ?></strong><br>
					<?php esc_html_e( 'Anyone can find it and request to join, but posts are only visible to members.', '6arshid-social-community-main' ); ?>
				</li>
				<li>
					<strong style="color:var(--arshid6social-text);"><?php esc_html_e( 'Hidden', '6arshid-social-community-main' ); ?></strong><br>
					<?php esc_html_e( 'Not listed in the directory. Invite-only access.', '6arshid-social-community-main' ); ?>
				</li>
			</ul>
		</aside>
...
$create_group_js = '( function () {
	...
	const i18n = {
		creating:     ' . wp_json_encode( __( 'Creating…', '6arshid-social-community-main' ) ) . ',
		createGroup:  ' . wp_json_encode( __( 'Create Group', '6arshid-social-community-main' ) ) . ',
		couldNotCreate: ' . wp_json_encode( __( 'Could not create group.', '6arshid-social-community-main' ) ) . ',
		networkError: ' . wp_json_encode( __( 'Network error. Please try again.', '6arshid-social-community-main' ) ) . ',
