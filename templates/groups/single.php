		...
		<div>
			...
			<?php if ( 'manage' === $current_tab && $is_admin ) : ?>
				...
				$groups_single_cfg = array(
					...
					'i18n'      => array(
						'saving'         => __( 'Saving…', '6arshid-social-community' ),
						'saved'          => __( 'Saved.', '6arshid-social-community' ),
						'couldNotSave'   => __( 'Could not save.', '6arshid-social-community' ),
						'networkError'   => __( 'Network error. Please try again.', '6arshid-social-community' ),
						'saveChanges'    => __( 'Save Changes', '6arshid-social-community' ),
						'confirmDelete'  => __( 'Are you sure you want to delete this group? This cannot be undone.', '6arshid-social-community' ),
						'deleting'       => __( 'Deleting…', '6arshid-social-community' ),
						'couldNotDelete' => __( 'Could not delete group.', '6arshid-social-community' ),
						'deleteGroup'    => __( 'Delete Group', '6arshid-social-community' ),
					),
				);
