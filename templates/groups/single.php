...
if ( $_group_suspended ) {
	...
	echo '<h2 class="arshid6social-suspended-notice__title">' . esc_html__( 'Group Suspended', '6arshid-social-community-main' ) . '</h2>';
	echo '<p class="arshid6social-suspended-notice__msg">' . esc_html__( 'This group has been suspended and its content is not available.', '6arshid-social-community-main' ) . '</p>';
	...
	if ( $_viewer_is_admin ) {
		echo '<a href="' . esc_url( admin_url( 'admin.php?page=arshid6social-moderation&moderation_view=groups' ) ) . '" class="arshid6social-btn arshid6social-btn-secondary">' . esc_html__( 'Manage in Admin', '6arshid-social-community-main' ) . '</a>';
	}
	echo '</div>';
	echo '</div>';
	echo '</div></div>';
...
$privacy_labels = array(
	'public'  => __( 'Public', '6arshid-social-community-main' ),
	'private' => __( 'Private', '6arshid-social-community-main' ),
	'hidden'  => __( 'Hidden', '6arshid-social-community-main' ),
);
...
if ( $is_admin ) {
	$tabs['manage'] = __( 'Manage', '6arshid-social-community-main' );
}
...
<div class="arshid6social-container" style="padding-block:2rem;">
	...
	<div class="arshid6social-card" id="arshid6social-group-header-card">
		...
		<div class="arshid6social-profile-cover"
			...
			printf( esc_attr__( '%s cover photo', '6arshid-social-community-main' ), esc_attr( $group['name'] ) ); ?>">
			<?php if ( $is_admin ) : ?>
				<button type="button" class="arshid6social-btn arshid6social-btn-sm arshid6social-btn-secondary arshid6social-cover-edit-btn"
					...
					<?php esc_html_e( 'Edit Cover', '6arshid-social-community-main' ); ?>
				</button>
			<?php endif; ?>
		</div>
			...
			<div class="arshid6social-avatar-wrap arshid6social-group-avatar-wrap">
				...
				<?php if ( $is_admin ) : ?>
					<button type="button" class="arshid6social-group-avatar-edit-btn"
						title="<?php esc_attr_e( 'Change group photo', '6arshid-social-community-main' ); ?>"
						data-group-id="<?php echo esc_attr( $group_id ); ?>">
						&#9998;
					</button>
				<?php endif; ?>
				...
				<div class="arshid6social-profile-meta">
					<span>
						...
						printf(
							...
							esc_html( _n( '%s member', '%s members', $group['memberCount'] ?? 0, '6arshid-social-community-main' ) ),
			...
			<div style="display:flex;gap:.5rem;flex-wrap:wrap;align-items:center;">
				<?php if ( is_user_logged_in() ) : ?>
					<?php if ( $is_member ) : ?>
						<button type="button" class="arshid6social-btn arshid6social-btn-secondary arshid6social-group-leave-btn"
							...
							<?php esc_html_e( 'Leave Group', '6arshid-social-community-main' ); ?>
						</button>
					<?php elseif ( $is_public ) : ?>
						<button type="button" class="arshid6social-btn arshid6social-btn-primary arshid6social-group-join-btn"
							...
							<?php esc_html_e( 'Join Group', '6arshid-social-community-main' ); ?>
						</button>
					<?php else : ?>
						<button type="button" class="arshid6social-btn arshid6social-btn-primary arshid6social-group-join-btn"
							data-group-id="<?php echo esc_attr( $group_id ); ?>"
				...
				<?php if ( is_user_logged_in() && ! $is_admin ) : ?>
					<button class="arshid6social-btn arshid6social-btn-ghost arshid6social-report-btn"
						...
						title="<?php esc_attr_e( 'Report this group', '6arshid-social-community-main' ); ?>">
		...
		<!-- Tabs -->
		<nav class="arshid6social-tabs" aria-label="<?php esc_attr_e( 'Group sections', '6arshid-social-community-main' ); ?>" role="tablist">
	...
	<div class="arshid6social-grid arshid6social-grid--sidebar" style="margin-block-start:1.5rem;">
		...
		<div>
			<div class="arshid6social-card arshid6social-card--about">
				<div class="arshid6social-card__header"><?php esc_html_e( 'About', '6arshid-social-community-main' ); ?></div>
				<div class="arshid6social-card__body">
					...
					<dl class="arshid6social-group-about-dl">
						<div>
							<dt><?php esc_html_e( 'Members', '6arshid-social-community-main' ); ?></dt>
							<dd><?php echo esc_html( number_format_i18n( $group['memberCount'] ?? 0 ) ); ?></dd>
						</div>
						<div>
							<dt><?php esc_html_e( 'Privacy', '6arshid-social-community-main' ); ?></dt>
		...
		<div>
					...
					<?php if ( $is_member && is_user_logged_in() ) : ?>
						<form class="arshid6social-activity-form arshid6social-card"
							...
							<textarea name="content" class="arshid6social-activity-composer"
								placeholder="<?php esc_attr_e( 'Post in this group…', '6arshid-social-community-main' ); ?>"
					...
					<?php elseif ( ! is_user_logged_in() ) : ?>
						<div class="arshid6social-card" style="padding:1.25rem;text-align:center;color:var(--arshid6social-text-muted);">
							<a href="<?php echo esc_url( wp_login_url( $group['url'] ?? '' ) ); ?>" class="arshid6social-btn arshid6social-btn-primary" style="margin-top:.5rem;">
								<?php esc_html_e( 'Log in to post', '6arshid-social-community-main' ); ?>
							</a>
						</div>
					<?php endif; ?>
					<div class="arshid6social-activity-feed" aria-label="<?php esc_attr_e( 'Group activity', '6arshid-social-community-main' ); ?>"></div>
			...
			<?php elseif ( 'members' === $current_tab ) : ?>
				...
				<div class="arshid6social-group-members-grid">
					...
					if ( empty( $rows ) ) :
						?>
						<p class="arshid6social-text-muted" style="color:var(--arshid6social-text-muted);"><?php esc_html_e( 'No members yet.', '6arshid-social-community-main' ); ?></p>
					<?php else : ?>
						...
						<div class="arshid6social-member-card arshid6social-card">
							...
							<div class="arshid6social-member-card-body">
								...
								<?php if ( $row->is_admin ) : ?>
									<span class="arshid6social-status-badge arshid6social-status-active"><?php esc_html_e( 'Admin', '6arshid-social-community-main' ); ?></span>
								<?php endif; ?>
							</div>
						</div>
						<?php endforeach; ?>
			...
			<?php if ( 'manage' === $current_tab && $is_admin ) : ?>
				...
				<div class="arshid6social-card" style="padding:2rem;margin-bottom:1.5rem;">
					<h2 style="margin:0 0 1.25rem;font-size:1.1rem;font-weight:600;"><?php esc_html_e( 'Edit Group', '6arshid-social-community-main' ); ?></h2>
					<form class="arshid6social-edit-group-form" novalidate>
						...
						<div class="arshid6social-form-group">
							<label class="arshid6social-label" for="arshid6social-edit-group-name">
								<?php esc_html_e( 'Group Name', '6arshid-social-community-main' ); ?> <span aria-hidden="true" style="color:var(--arshid6social-danger);">*</span>
							</label>
						...
						<div class="arshid6social-form-group">
							<label class="arshid6social-label" for="arshid6social-edit-group-status">
								<?php esc_html_e( 'Privacy', '6arshid-social-community-main' ); ?>
							</label>
							<select id="arshid6social-edit-group-status" name="status" class="arshid6social-input">
								<option value="public"  <?php selected( $group['status'], 'public' ); ?>><?php esc_html_e( 'Public — anyone can join and see posts', '6arshid-social-community-main' ); ?></option>
								<option value="private" <?php selected( $group['status'], 'private' ); ?>><?php esc_html_e( 'Private — anyone can request, but only members see posts', '6arshid-social-community-main' ); ?></option>
								<option value="hidden"  <?php selected( $group['status'], 'hidden' ); ?>><?php esc_html_e( 'Hidden — invite only, not listed in directory', '6arshid-social-community-main' ); ?></option>
							</select>
						</div>
						...
						<div class="arshid6social-form-actions">
							<button type="submit" class="arshid6social-btn arshid6social-btn-primary">
								<?php esc_html_e( 'Save Changes', '6arshid-social-community-main' ); ?>
							</button>
						</div>
					</form>
				</div>
				...
				<div class="arshid6social-card" style="padding:2rem;border:1px solid var(--arshid6social-danger,#dc2626);">
					<h2 style="margin:0 0 .5rem;font-size:1.1rem;font-weight:600;color:var(--arshid6social-danger,#dc2626);"><?php esc_html_e( 'Delete Group', '6arshid-social-community-main' ); ?></h2>
					<p style="margin:0 0 1rem;color:var(--arshid6social-text-muted);"><?php esc_html_e( 'Permanently delete this group and all its data. This cannot be undone.', '6arshid-social-community-main' ); ?></p>
					<button type="button" class="arshid6social-btn arshid6social-btn-danger arshid6social-group-delete-btn"
						...
						<?php esc_html_e( 'Delete Group', '6arshid-social-community-main' ); ?>
					</button>
				</div>
