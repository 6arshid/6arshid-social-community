...
<div class="arshid6social-wrap arshid6social-single-activity-page">
	...
	<nav class="arshid6social-breadcrumb">
		<a href="<?php echo esc_url( home_url( '/activity/' ) ); ?>"><?php esc_html_e( 'Activity', 'social-network-6' ); ?></a>
		<span aria-hidden="true"> › </span>
		<span><?php esc_html_e( 'Post', 'social-network-6' ); ?> #<?php echo esc_html( $activity['id'] ); ?></span>
	</nav>
	...
	<div id="arshid6social-single-activity-wrap"
		...
		<div class="arshid6social-activity-feed" role="main" aria-label="<?php esc_attr_e( 'Activity post', 'social-network-6' ); ?>"></div>
	</div>
	...
	<div id="arshid6social-single-more-wrap" class="arshid6social-single-more-from">
		<h3 class="arshid6social-single-more-title">
			...
			printf(
				...
				esc_html__( 'More from %s', 'social-network-6' ),
