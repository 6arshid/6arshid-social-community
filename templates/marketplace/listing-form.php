...
$step_labels = array(
	1 => __( 'Category', 'social-network-6' ),
	2 => __( 'Photos', 'social-network-6' ),
	3 => __( 'Details', 'social-network-6' ),
	4 => __( 'Location', 'social-network-6' ),
	5 => __( 'Review', 'social-network-6' ),
);
...
<div class="arshid6social-mkt-wrap arshid6social-mkt-form-page" id="arshid6social-listing-wizard"
	...
	<a href="<?php echo esc_url( $base_url ); ?>" class="arshid6social-mkt-back-link">
		...
		<?php esc_html_e( 'Back to Marketplace', 'social-network-6' ); ?>
	</a>

	<h1 class="arshid6social-mkt-page-title"><?php esc_html_e( 'Post a Listing', 'social-network-6' ); ?></h1>

	<?php /* ── Step progress ───────────────────────────────────────────────── */ ?>
	<div class="arshid6social-mkt-steps" role="tablist" aria-label="<?php esc_attr_e( 'Listing wizard steps', 'social-network-6' ); ?>">
	...
	<form id="arshid6social-mkt-listing-form" class="arshid6social-mkt-form" novalidate>
		...
		<div class="arshid6social-mkt-panel is-active" data-panel="1">
			<h2 class="arshid6social-mkt-panel-title"><?php esc_html_e( 'What are you selling?', 'social-network-6' ); ?></h2>

			<div class="arshid6social-mkt-field">
				<label class="arshid6social-mkt-label" for="mkt-title">
					<?php esc_html_e( 'Title', 'social-network-6' ); ?>
				...
				<input type="text" id="mkt-title" name="title" class="arshid6social-mkt-input"
					maxlength="200"
					placeholder="<?php esc_attr_e( 'e.g. iPhone 15 Pro 256 GB, Black', 'social-network-6' ); ?>"
					required
			...
			<div class="arshid6social-mkt-field">
				...
				<select id="mkt-category" name="category_id" class="arshid6social-mkt-select" required>
					<option value=""><?php esc_html_e( '— Select a category —', 'social-network-6' ); ?></option>
			...
			<div class="arshid6social-mkt-panel-nav">
				...
				<button type="button" class="arshid6social-mkt-btn arshid6social-mkt-btn--primary arshid6social-mkt-next" data-next="2">
					<?php esc_html_e( 'Next: Photos', 'social-network-6' ); ?>
		...
		<div class="arshid6social-mkt-panel" data-panel="2">
			<h2 class="arshid6social-mkt-panel-title"><?php esc_html_e( 'Add Photos', 'social-network-6' ); ?></h2>
			<p class="arshid6social-mkt-panel-desc">
				<?php printf(
					/* translators: 1: max photos, 2: max MB */
					esc_html__( 'Upload up to %1$d photos (max %2$d MB each). The first photo will be the cover.', 'social-network-6' ),
					absint( $max_photos ),
					absint( $max_mb )
				); ?>
			</p>
			...
			<div id="arshid6social-mkt-photo-drop" class="arshid6social-mkt-photo-drop" tabindex="0" role="button"
				aria-label="<?php esc_attr_e( 'Upload photos — click or drag and drop', 'social-network-6' ); ?>">
				...
				<p><?php esc_html_e( 'Click to add photos or drag &amp; drop here', 'social-network-6' ); ?></p>
				<span class="arshid6social-mkt-photo-count-label" id="arshid6social-mkt-photo-count-label">
					<?php printf(
						...
						esc_html__( '%1$d / %2$d photos', 'social-network-6' ),
						0,
						absint( $max_photos )
					); ?>
				</span>
			...
			<div id="arshid6social-mkt-photo-grid" class="arshid6social-mkt-photo-grid" aria-label="<?php esc_attr_e( 'Uploaded photos', 'social-network-6' ); ?>"></div>
		...
		<div class="arshid6social-mkt-panel" data-panel="3">
			<h2 class="arshid6social-mkt-panel-title"><?php esc_html_e( 'Listing Details', 'social-network-6' ); ?></h2>

			<?php /* Price row */ ?>
			<div class="arshid6social-mkt-field">
				<label class="arshid6social-mkt-label"><?php esc_html_e( 'Price', 'social-network-6' ); ?></label>
				...
				<div class="arshid6social-mkt-price-row">
					...
					<label class="arshid6social-mkt-toggle-label" for="mkt-is-free">
						...
						<span class="arshid6social-mkt-toggle-text"><?php esc_html_e( 'Free', 'social-network-6' ); ?></span>
					</label>
					<label class="arshid6social-mkt-toggle-label" id="arshid6social-mkt-neg-label" for="mkt-is-negotiable">
						...
						<span class="arshid6social-mkt-toggle-text"><?php esc_html_e( 'Negotiable', 'social-network-6' ); ?></span>
					</label>
				</div>
			</div>
			...
			<?php /* Condition */ ?>
			<div class="arshid6social-mkt-field">
				<label class="arshid6social-mkt-label"><?php esc_html_e( 'Condition', 'social-network-6' ); ?></label>
				<div class="arshid6social-mkt-condition-grid" role="group" aria-label="<?php esc_attr_e( 'Item condition', 'social-network-6' ); ?>">
			...
			<div class="arshid6social-mkt-field">
				...
				<textarea id="mkt-description" name="description" class="arshid6social-mkt-textarea" rows="6"
					placeholder="<?php esc_attr_e( 'Describe your item — condition, dimensions, reason for selling, included accessories…', 'social-network-6' ); ?>"
					maxlength="5000"
			...
			<div class="arshid6social-mkt-panel-nav">
				...
				<button type="button" class="arshid6social-mkt-btn arshid6social-mkt-btn--primary arshid6social-mkt-next" data-next="4">
					<?php esc_html_e( 'Next: Location', 'social-network-6' ); ?>
					<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="9 18 15 12 9 6"/></svg>
				</button>
			</div>
		</div>
		...
		<div class="arshid6social-mkt-panel" data-panel="4">
			<h2 class="arshid6social-mkt-panel-title"><?php esc_html_e( 'Location', 'social-network-6' ); ?></h2>
			<p class="arshid6social-mkt-panel-desc"><?php esc_html_e( 'Your exact address is never shown. Only city/region is displayed to buyers.', 'social-network-6' ); ?></p>

			<div class="arshid6social-mkt-field">
				<label class="arshid6social-mkt-label" for="mkt-city"><?php esc_html_e( 'City / Region', 'social-network-6' ); ?></label>
				<input type="text" id="mkt-city" name="location_city" class="arshid6social-mkt-input"
					placeholder="<?php esc_attr_e( 'e.g. Tehran, New York…', 'social-network-6' ); ?>">
			</div>

			<div class="arshid6social-mkt-field">
				<label class="arshid6social-mkt-label" for="mkt-country"><?php esc_html_e( 'Country', 'social-network-6' ); ?></label>
				<select id="mkt-country" name="location_country" class="arshid6social-mkt-select">
					<option value=""><?php esc_html_e( '— Select country —', 'social-network-6' ); ?></option>
					<?php
					$countries = array(
			...
			<div class="arshid6social-mkt-field">
				<button type="button" id="arshid6social-mkt-geolocate" class="arshid6social-mkt-btn arshid6social-mkt-btn--outline arshid6social-mkt-btn--sm">
					...
					<?php esc_html_e( 'Use my current location', 'social-network-6' ); ?>
				</button>
			...
			<div class="arshid6social-mkt-panel-nav">
				...
				<button type="button" class="arshid6social-mkt-btn arshid6social-mkt-btn--primary arshid6social-mkt-next" data-next="5">
					<?php esc_html_e( 'Review Listing', 'social-network-6' ); ?>
					<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="9 18 15 12 9 6"/></svg>
				</button>
			</div>
		</div>
		...
		<div class="arshid6social-mkt-panel" data-panel="5">
			<h2 class="arshid6social-mkt-panel-title"><?php esc_html_e( 'Review Your Listing', 'social-network-6' ); ?></h2>
			...
			<div id="arshid6social-mkt-preview-card" class="arshid6social-mkt-preview-card">
				...
				<div class="arshid6social-mkt-preview-body">
					...
					<p class="arshid6social-mkt-preview-title" id="arshid6social-mkt-preview-title"><?php esc_html_e( '(no title)', 'social-network-6' ); ?></p>
			...
			<div class="arshid6social-mkt-moderation-notice">
				...
				<?php esc_html_e( 'Your listing will be reviewed before it appears publicly.', 'social-network-6' ); ?>
			</div>
			<?php endif; ?>
			...
			<div class="arshid6social-mkt-panel-nav arshid6social-mkt-panel-nav--publish">
				...
				<div class="arshid6social-mkt-publish-actions">
					<button type="button" id="arshid6social-mkt-save-draft" class="arshid6social-mkt-btn arshid6social-mkt-btn--outline">
						<?php esc_html_e( 'Save as Draft', 'social-network-6' ); ?>
					</button>
					<button type="button" id="arshid6social-mkt-publish" class="arshid6social-mkt-btn arshid6social-mkt-btn--primary">
						<span class="arshid6social-mkt-btn-text">
							<?php echo 'manual' === $moderation
								? esc_html__( 'Submit for Review', 'social-network-6' )
								: esc_html__( 'Publish Listing', 'social-network-6' ); ?>
						</span>
						<span class="arshid6social-mkt-btn-spinner" hidden aria-hidden="true">
							<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" class="arshid6social-spin" aria-label="<?php esc_attr_e( 'Loading', 'social-network-6' ); ?>"><path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4M4.93 19.07l2.83-2.83M16.24 7.76l2.83-2.83"/></svg>
						</span>
					</button>
				</div>
			</div>
...
function validateStep( step ) {
	...
	if ( step === 1 ) {
		...
		if ( ! title ) { showErr( '<?php echo esc_js( __( 'Please enter a title for your listing.', 'social-network-6' ) ); ?>' ); return false; }
		if ( ! cat )   { showErr( '<?php echo esc_js( __( 'Please select a category.', 'social-network-6' ) ); ?>' ); return false; }
	}
	return true;
}
...
function updatePhotoCount() {
	if ( cntLabel ) cntLabel.textContent = uploadedPhotos.length + ' / ' + MAX_PH + ' <?php echo esc_js( __( 'photos', 'social-network-6' ) ); ?>';
...
function renderPhotoGrid() {
	...
	uploadedPhotos.forEach( ( p, i ) => {
		...
		img.src = p.thumb;
		img.alt = '<?php echo esc_js( __( 'Listing photo', 'social-network-6' ) ); ?>';
		div.appendChild( img );

		if ( i === 0 ) {
			const badge = document.createElement( 'span' );
			badge.className = 'arshid6social-mkt-photo-primary';
			badge.textContent = '<?php echo esc_js( __( 'Cover', 'social-network-6' ) ); ?>';
		...
		del.setAttribute( 'aria-label', '<?php echo esc_js( __( 'Remove photo', 'social-network-6' ) ); ?>' );
		del.innerHTML = '×';
...
async function uploadPhoto( file ) {
	if ( uploadedPhotos.length >= MAX_PH ) {
		showPhotoErr( '<?php echo esc_js( __( 'Maximum photos reached.', 'social-network-6' ) ); ?>' );
		return;
	}
	if ( file.size > MAX_MB * 1024 * 1024 ) {
		showPhotoErr( '<?php echo esc_js( __( 'File is too large.', 'social-network-6' ) ); ?>' );
		return;
	}
	...
	try {
		...
		if ( data.success && idx > -1 ) {
			...
			showPhotoErr( ( data.data && data.data.message ) || '<?php echo esc_js( __( 'Upload failed.', 'social-network-6' ) ); ?>' );
		}
	} catch ( err ) {
		uploadedPhotos = uploadedPhotos.filter( p => p.id !== tempId );
		showPhotoErr( '<?php echo esc_js( __( 'Network error — please try again.', 'social-network-6' ) ); ?>' );
	}
...
if ( geoBtn ) {
	geoBtn.addEventListener( 'click', () => {
		if ( ! navigator.geolocation ) {
			geoStatus.textContent = '<?php echo esc_js( __( 'Geolocation not supported.', 'social-network-6' ) ); ?>';
			return;
		}
		geoStatus.textContent = '<?php echo esc_js( __( 'Detecting location…', 'social-network-6' ) ); ?>';
		...
		navigator.geolocation.getCurrentPosition(
			pos => {
				...
				geoStatus.textContent = '<?php echo esc_js( __( 'Location captured!', 'social-network-6' ) ); ?>';
				geoBtn.disabled = false;
			},
			() => {
				geoStatus.textContent = '<?php echo esc_js( __( 'Could not get location.', 'social-network-6' ) ); ?>';
				geoBtn.disabled = false;
			},
			{ timeout: 8000 }
		);
...
function buildPreview() {
	const title     = ( document.getElementById( 'mkt-title' )?.value.trim() ) || '(<?php echo esc_js( __( 'no title', 'social-network-6' ) ); ?>)';
	...
	let priceText = isFreeChk ? '<?php echo esc_js( __( 'Free', 'social-network-6' ) ); ?>'
		: ( sym + ( parseFloat( priceVal ) || 0 ).toLocaleString() );
	if ( ! isFreeChk && isNeg ) priceText += ' · <?php echo esc_js( __( 'Negotiable', 'social-network-6' ) ); ?>';
...
async function submitListing( action ) {
	...
	try {
		...
		if ( data.success ) {
			...
			setPublishing( false );
			showErr( ( data.data && data.data.message ) || '<?php echo esc_js( __( 'An error occurred. Please try again.', 'social-network-6' ) ); ?>' );
		}
	} catch ( err ) {
		setPublishing( false );
		showErr( '<?php echo esc_js( __( 'Network error. Please check your connection.', 'social-network-6' ) ); ?>' );
	}
}
