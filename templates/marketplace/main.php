...
$mkt_main_css =
	...
	'.arshid6social-dark-mode .arshid6social-mkt-search-inner,.arshid6social-dark-mode .arshid6social-mkt-cat-card,.arshid6social-dark-mode .arshid6social-mkt-card,.arshid6social-dark-mode .arshid6social-mkt-sort-select,.arshid6social-dark-mode .arshid6social-mkt-view-btn{background:#1e293b}' .
...
wp_add_inline_style( 'arshid6social-mkt-main-inline', $mkt_main_css );
...
wp_add_inline_script( 'arshid6social-main', 'var ARSHID6SOCIALMktMainI18n=' . wp_json_encode( $mkt_main_i18n ) . ';' );
$mkt_main_js = <<<'ENDMKTMAINJS'
(function () {
	'use strict';

	const I18N    = window.ARSHID6SOCIALMktMainI18n || {};
	...
	async function fetchListings( page, append ) {
		...
		try {
			...
			isLoading           = false;
			moreBtn.textContent = I18N.loadMore;
	...
	function appendCard( listing ) {
		...
		let badge = '';
		if ( listing.is_free )             badge = '<span class="arshid6social-mkt-card-badge arshid6social-mkt-card-badge--free">' + I18N.free + '</span>';
		else if ( listing.status === 'sold' ) badge = '<span class="arshid6social-mkt-card-badge arshid6social-mkt-card-badge--sold">' + I18N.sold + '</span>';
		else if ( listing.is_negotiable )  badge = '<span class="arshid6social-mkt-card-badge arshid6social-mkt-card-badge--negot">' + I18N.negotiable + '</span>';
...
ENDMKTMAINJS;
wp_add_inline_script( 'arshid6social-main', $mkt_main_js );
?>
