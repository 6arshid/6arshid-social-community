...
<div class="arshid6social-directory-wrap" id="arshid6social-members-page">
	...
	<div class="arshid6social-toolbar">
		<div class="arshid6social-search-wrap">
			<input type="search"
				...
				aria-label="<?php esc_attr_e( 'Search members', '6arshid-social-community-main' ); ?>"
			/>
		</div>
		<div class="arshid6social-filter-wrap">
			<select class="arshid6social-sort-select" data-type="member">
				...
				<option value="active"><?php esc_html_e( 'Recently Active', '6arshid-social-community-main' ); ?></option>
				<option value="alphabetical"><?php esc_html_e( 'Alphabetical', '6arshid-social-community-main' ); ?></option>
			</select>
		</div>
	</div>
	<?php endif; ?>
	...
	<div id="arshid6social-member-directory"
		...
		<div class="arshid6social-member-grid" role="list" aria-label="<?php esc_attr_e( 'Member directory', '6arshid-social-community-main' ); ?>">
			<?php for ( $i = 0; $i < 8; $i++ ) : ?>
		...
		<div class="arshid6social-pagination" role="navigation" aria-label="<?php esc_attr_e( 'Member directory pagination', '6arshid-social-community-main' ); ?>"></div>
	</div>
</div>
