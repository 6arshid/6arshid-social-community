...
<div class="arshid6social-directory-wrap" id="arshid6social-members-page">
	...
	<div class="arshid6social-toolbar">
		<div class="arshid6social-search-wrap">
			<input type="search"
				...
				aria-label="<?php esc_attr_e( 'Search members', 'social-network-6' ); ?>"
			/>
		</div>
		<div class="arshid6social-filter-wrap">
			<select class="arshid6social-sort-select" data-type="member">
				...
				<option value="active"><?php esc_html_e( 'Recently Active', 'social-network-6' ); ?></option>
				<option value="alphabetical"><?php esc_html_e( 'Alphabetical', 'social-network-6' ); ?></option>
			</select>
		</div>
	</div>
	<?php endif; ?>
	...
	<div id="arshid6social-member-directory"
		...
		<div class="arshid6social-member-grid" role="list" aria-label="<?php esc_attr_e( 'Member directory', 'social-network-6' ); ?>">
			<?php for ( $i = 0; $i < 8; $i++ ) : ?>
		...
		<div class="arshid6social-pagination" role="navigation" aria-label="<?php esc_attr_e( 'Member directory pagination', 'social-network-6' ); ?>"></div>
	</div>
</div>
