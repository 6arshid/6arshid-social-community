...
if ( ! $is_self && is_user_logged_in() ) {
	...
	if ( $_friends_comp && $_friends_comp->is_blocked( get_current_user_id(), $profile_user->ID ) ) {
		...
		echo '<p>' . esc_html__( 'This profile is not available.', '6arshid-social-community-main' ) . '</p>';
		echo '</div></div>';
		return;
	}
}
...
if ( $_profile_suspended ) {
	...
	if ( $is_self ) {
		echo '<h2 class="arshid6social-suspended-notice__title">' . esc_html__( 'Your Account is Suspended', '6arshid-social-community-main' ) . '</h2>';
		echo '<p class="arshid6social-suspended-notice__msg">' . esc_html__( 'Your account has been suspended. Please contact an administrator for more information.', '6arshid-social-community-main' ) . '</p>';
		...
		echo '<h2 class="arshid6social-suspended-notice__title">' . esc_html__( 'Account Suspended', '6arshid-social-community-main' ) . '</h2>';
		echo '<p class="arshid6social-suspended-notice__msg">' . esc_html__( 'This account has been suspended and its content is not available.', '6arshid-social-community-main' ) . '</p>';
	}
	echo '<div class="arshid6social-suspended-notice__actions">';
	echo '<a href="' . esc_url( home_url( '/' ) ) . '" class="arshid6social-btn arshid6social-btn-primary">' . esc_html__( 'Back to Home', '6arshid-social-community-main' ) . '</a>';
	if ( $_viewer_is_admin ) {
		...
		echo '<a href="' . esc_url( admin_url( 'admin.php?page=arshid6social-members' ) ) . '" class="arshid6social-btn arshid6social-btn-secondary">' . esc_html__( 'Manage in Admin', '6arshid-social-community-main' ) . '</a>';
	}
	echo '</div>';
	echo '</div>';
	echo '</div></div>';
...
$tabs = apply_filters(
	...
	array(
		...
		'about'       => __( 'About', '6arshid-social-community-main' ),
	),
	$profile_user
);
...
if ( $is_self ) {
	...
	$notif_label  = __( 'Notifications', '6arshid-social-community-main' );
	if ( $unread_count ) {
	...
	$tabs['settings']      = __( 'Settings', '6arshid-social-community-main' );
}
...
<div class="arshid6social-wrap" id="arshid6social-profile-page">
	<div class="arshid6social-container" style="padding-block: 2rem;">
		...
		<div class="arshid6social-card">
			...
			<div class="arshid6social-profile-cover"
				...
				aria-label="<?php
					printf(
						...
						esc_attr__( '%s cover photo', '6arshid-social-community-main' ),
			...
			>
				<?php if ( $is_self ) : ?>
					<button class="arshid6social-cover-edit-btn"
						...
						title="<?php esc_attr_e( 'Edit Cover', '6arshid-social-community-main' ); ?>"
						aria-label="<?php esc_attr_e( 'Edit Cover', '6arshid-social-community-main' ); ?>">
			...
			<div class="arshid6social-profile-header">
				<div class="arshid6social-avatar-wrap">
					...
					<?php if ( $component->is_user_online( $profile_user->ID ) ) : ?>
						<span class="arshid6social-online-badge" aria-label="<?php esc_attr_e( 'Online', '6arshid-social-community-main' ); ?>"></span>
					<?php endif; ?>
				</div>
				...
				<div class="arshid6social-profile-header__info">
					<h1 class="arshid6social-profile-name">
						...
						<?php if ( $_profile_suspended ) : ?>
							<span class="arshid6social-badge arshid6social-badge--suspended arshid6social-badge--sm" style="vertical-align:middle;font-size:.65rem;">
								<?php esc_html_e( 'Suspended', '6arshid-social-community-main' ); ?>
							</span>
						<?php endif; ?>
						<?php
					...
					?>
							<span class="arshid6social-verified-badge" title="<?php esc_attr_e( 'Verified Member', '6arshid-social-community-main' ); ?>" aria-label="<?php esc_attr_e( 'Verified', '6arshid-social-community-main' ); ?>">&#10003;</span>
						<?php endif; ?>
					</h1>
					<div class="arshid6social-profile-stats">
						<div>
							...
							<?php esc_html_e( 'Friends', '6arshid-social-community-main' ); ?>
						</div>
					</div>
				</div>
				...
				<div class="arshid6social-profile-actions">
					<?php if ( $is_self ) : ?>
						<a href="<?php echo esc_url( $profile_url . 'settings/' ); ?>" class="arshid6social-btn arshid6social-btn--secondary">
							...
							<?php esc_html_e( 'Edit Profile', '6arshid-social-community-main' ); ?>
						</a>
						...
						<button class="arshid6social-btn arshid6social-btn--secondary" onclick="document.getElementById('arshid6social-avatar-input').click()">
							...
							<?php esc_html_e( 'Change Photo', '6arshid-social-community-main' ); ?>
						</button>
					<?php elseif ( is_user_logged_in() ) :
						...
						$friend_labels  = array(
							...
							'pending_sent'     => __( 'Cancel Request', '6arshid-social-community-main' ),
							'pending_received' => __( 'Accept Request', '6arshid-social-community-main' ),
							'friends'          => __( 'Friends ✓', '6arshid-social-community-main' ),
						);
					?>
						<button class="arshid6social-btn arshid6social-btn--primary arshid6social-friend-btn"
							...
							<?php echo esc_html( $friend_labels[ $friend_status ] ?? __( 'Add Friend', '6arshid-social-community-main' ) ); ?>
						</button>
						<a href="<?php echo esc_url( home_url( '/messages/compose/?to=' . \Arshid6Social\Components\Messages\Messages::get_user_uid( $profile_user->ID ) ) ); ?>"
							...
							<?php esc_html_e( 'Send Message', '6arshid-social-community-main' ); ?>
						</a>
						...
						<button class="arshid6social-btn arshid6social-btn--ghost arshid6social-btn--sm arshid6social-report-btn arshid6social-profile-report-btn"
							...
							title="<?php esc_attr_e( 'Report this profile', '6arshid-social-community-main' ); ?>">
					...
					<?php else : ?>
						<a href="<?php echo esc_url( wp_login_url( get_permalink() ) ); ?>" class="arshid6social-btn arshid6social-btn--primary">
							<?php esc_html_e( 'Connect', '6arshid-social-community-main' ); ?>
						</a>
					<?php endif; ?>
				</div>
			</div>
			...
			<!-- Tabs -->
			<nav class="arshid6social-tabs" role="tablist" aria-label="<?php esc_attr_e( 'Profile sections', '6arshid-social-community-main' ); ?>">
		...
		<div class="arshid6social-profile-content" style="margin-block-start:1.5rem;">
			...
			<div class="arshid6social-card arshid6social-card--about" id="arshid6social-about-card">
				<div class="arshid6social-about-row">
					<span class="arshid6social-about-label"><?php esc_html_e( 'About', '6arshid-social-community-main' ); ?></span>
					<span class="arshid6social-about-bio" id="arshid6social-bio-display">
						<?php if ( $about_bio ) : ?>
							<?php echo wp_kses_post( $about_bio ); ?>
						<?php else : ?>
							<span class="arshid6social-text-muted"><?php esc_html_e( 'No bio yet.', '6arshid-social-community-main' ); ?></span>
						<?php endif; ?>
					</span>
					<?php if ( $is_self ) : ?>
						<button type="button" class="arshid6social-btn arshid6social-btn--ghost arshid6social-btn--sm arshid6social-about-edit-btn" id="arshid6social-bio-edit-btn" aria-label="<?php esc_attr_e( 'Edit bio', '6arshid-social-community-main' ); ?>">
				...
				<div id="arshid6social-bio-edit-form" hidden style="padding:.65rem 1rem; border-top:1px solid var(--arshid6social-border);">
					...
					<div style="display:flex;gap:.5rem;margin-block-start:.5rem;">
						<button type="button" class="arshid6social-btn arshid6social-btn--primary arshid6social-btn--sm" id="arshid6social-bio-save-btn"><?php esc_html_e( 'Save', '6arshid-social-community-main' ); ?></button>
						<button type="button" class="arshid6social-btn arshid6social-btn--ghost arshid6social-btn--sm" id="arshid6social-bio-cancel-btn"><?php esc_html_e( 'Cancel', '6arshid-social-community-main' ); ?></button>
					</div>
				</div>
				<?php endif; ?>
			</div>
			...
			<div class="arshid6social-card arshid6social-sidebar-stories">
				<div class="arshid6social-sidebar-stories__header">
					<span><?php esc_html_e( 'Stories', '6arshid-social-community-main' ); ?></span>
				</div>
			...
			switch ( $active_tab ) {
				case 'activity':
					...
					<div id="arshid6social-activity-feed"
						...
						data-scope="personal"
						role="feed"
						aria-label="<?php esc_attr_e( 'Activity feed', '6arshid-social-community-main' ); ?>">
