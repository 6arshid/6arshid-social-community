...
class Friends {
	...
	public function send_request( int $initiator_id, int $friend_id ): bool|string {
		if ( $initiator_id === $friend_id ) {
			return __( 'You cannot friend yourself.', '6arshid-social-community-main' );
		}

		if ( $this->is_blocked( $initiator_id, $friend_id ) ) {
			return __( 'Unable to send friend request.', '6arshid-social-community-main' );
		}

		$status = $this->get_friendship_status( $initiator_id, $friend_id );
		if ( 'not_friends' !== $status ) {
			return __( 'A friend request already exists.', '6arshid-social-community-main' );
		}
	...
	public function ajax_send_friend_request(): void {
		...
		if ( ! $this->check_rate_limit() ) {
			wp_send_json_error( array( 'message' => __( 'Too many friend requests. Please wait.', '6arshid-social-community-main' ) ), 429 );
		}

		$result = $this->send_request( get_current_user_id(), $target );
		if ( true === $result ) {
			wp_send_json_success( array( 'status' => 'pending_sent', 'message' => __( 'Friend request sent.', '6arshid-social-community-main' ) ) );
		} else {
			wp_send_json_error( array( 'message' => $result ?: __( 'Could not send request.', '6arshid-social-community-main' ) ) );
		}
	}
	...
	public function ajax_accept_friend_request(): void {
		...
		wp_send_json_success( array( 'status' => 'friends', 'message' => __( 'Friend request accepted.', '6arshid-social-community-main' ) ) );
	}
	...
	public function ajax_reject_friend_request(): void {
		...
		wp_send_json_success( array( 'status' => 'not_friends', 'message' => __( 'Request rejected.', '6arshid-social-community-main' ) ) );
	}
	...
	public function ajax_remove_friend(): void {
		...
		wp_send_json_success( array( 'status' => 'not_friends', 'message' => __( 'Friend removed.', '6arshid-social-community-main' ) ) );
	}
	...
	public function ajax_follow_user(): void {
		...
		wp_send_json_success( array( 'following' => true, 'message' => __( 'You are now following this member.', '6arshid-social-community-main' ) ) );
	}
	...
	public function ajax_unfollow_user(): void {
		...
		wp_send_json_success( array( 'following' => false, 'message' => __( 'You have unfollowed this member.', '6arshid-social-community-main' ) ) );
	}
	...
	public function ajax_block_user(): void {
		...
		wp_send_json_success( array( 'blocked' => true, 'message' => __( 'User blocked.', '6arshid-social-community-main' ) ) );
	}
	...
	public function ajax_unblock_user(): void {
		...
		wp_send_json_success( array( 'blocked' => false, 'message' => __( 'User unblocked.', '6arshid-social-community-main' ) ) );
	}
