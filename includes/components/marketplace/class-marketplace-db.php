...
class Marketplace_DB {
	...
	private static function seed_default_options(): void {
		$defaults = array(
			...
			'arshid6social_marketplace_safety_tips'        => __( 'Meet in a public place. Inspect the item before paying. Never share personal financial information.', '6arshid-social-community-main' ),
			'arshid6social_marketplace_prohibited_policy'  => __( 'The following items are prohibited: weapons, illegal substances, counterfeit goods, and any other items prohibited by local law.', '6arshid-social-community-main' ),
