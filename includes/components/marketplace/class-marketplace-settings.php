...
class Marketplace_Settings {
	...
	private function enqueue_categories_script(): void {
		$confirm_delete = __( 'Delete this category? Its sub-categories will be moved to the top level.', '6arshid social community' );
		$label_add      = __( 'Add Category', '6arshid social community' );
		$label_edit     = __( 'Edit Category', '6arshid social community' );
		$label_saving   = __( 'Saving…', '6arshid social community' );
		$label_saved    = __( 'Saved.', '6arshid social community' );
		$label_error    = __( 'Error. Please try again.', '6arshid social community' );
		?>
		<script>
		(function() {
