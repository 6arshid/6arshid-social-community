...
function arshid6social_report_modal(): void {
	...
	<div id="arshid6social-report-modal" class="arshid6social-modal-overlay" role="dialog" aria-modal="true" aria-labelledby="arshid6social-rm-title" hidden>
		<div class="arshid6social-modal-box">
			<button class="arshid6social-modal-close" id="arshid6social-rm-close" aria-label="<?php esc_attr_e( 'Close', 'social-network-6' ); ?>">&times;</button>
			<h2 class="arshid6social-modal-title" id="arshid6social-rm-title"><?php esc_html_e( 'Report', 'social-network-6' ); ?></h2>
			<p class="arshid6social-modal-desc"><?php esc_html_e( 'Why are you reporting this?', 'social-network-6' ); ?></p>

			<div id="arshid6social-rm-reasons" class="arshid6social-report-reasons"></div>

			<label class="arshid6social-report-label" for="arshid6social-rm-notes"><?php esc_html_e( 'Additional details (optional)', 'social-network-6' ); ?></label>
			<textarea id="arshid6social-rm-notes" class="arshid6social-report-notes" rows="3"
				placeholder="<?php esc_attr_e( 'Tell us more about this report…', 'social-network-6' ); ?>"></textarea>

			<div id="arshid6social-rm-attachment-wrap" hidden>
				<label class="arshid6social-report-label" for="arshid6social-rm-file"><?php esc_html_e( 'Attach a screenshot (optional)', 'social-network-6' ); ?></label>
			...
			<div class="arshid6social-modal-actions">
				<button class="arshid6social-btn arshid6social-btn--secondary" id="arshid6social-rm-cancel"><?php esc_html_e( 'Cancel', 'social-network-6' ); ?></button>
				<button class="arshid6social-btn arshid6social-btn--danger" id="arshid6social-rm-submit" disabled><?php esc_html_e( 'Submit Report', 'social-network-6' ); ?></button>
			</div>
