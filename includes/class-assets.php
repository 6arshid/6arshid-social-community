...
final class Assets {
	...
	public function enqueue_frontend(): void {
		...
		if ( get_option( 'arshid6social_stories_enabled', false ) ) {
			...
			wp_localize_script( 'arshid6social-stories', 'ARSHID6SOCIALStories', array(
				...
				'i18n'         => array(
					'confirmDelete'  => __( 'Delete this story?', '6arshid-social-community-main' ),
					'highlightTitle' => __( 'Highlight name:', '6arshid-social-community-main' ),
					'noViewers'      => __( 'No viewers yet.', '6arshid-social-community-main' ),
				),
			) );
		}
		...
		if ( get_option( 'arshid6social_blocking_enabled', true ) ) {
			...
			wp_localize_script( 'arshid6social-blocking', 'ARSHID6SOCIALBlocking', array(
				...
				'i18n'       => array(
					'reasonPrompt'   => __( 'Reason for blocking (optional):', '6arshid-social-community-main' ),
					'confirmBlock'   => __( 'Block this user?', '6arshid-social-community-main' ),
					'confirmUnblock' => __( 'Unblock this user?', '6arshid-social-community-main' ),
					'blocked'        => __( 'Blocked', '6arshid-social-community-main' ),
					'block'          => __( 'Block', '6arshid-social-community-main' ),
					'blockError'     => __( 'Could not block user. Please try again.', '6arshid-social-community-main' ),
					'emptyList'      => __( 'You have not blocked anyone.', '6arshid-social-community-main' ),
				),
			) );
		}
		...
		if ( get_option( 'arshid6social_verification_enabled', false ) ) {
			...
			wp_localize_script( 'arshid6social-verification', 'ARSHID6SOCIALVerification', array(
				...
				'ajaxUrl' => admin_url( 'admin-ajax.php' ),
				'i18n'    => array(
					'selectType'       => __( 'Please select a verification type.', '6arshid-social-community-main' ),
					'nameRequired'     => __( 'Please enter your full name.', '6arshid-social-community-main' ),
					'requestSubmitted' => __( 'Your request has been submitted. We\'ll review it and notify you.', '6arshid-social-community-main' ),
					'submitError'      => __( 'Could not submit request.', '6arshid-social-community-main' ),
				),
			) );
		}
		...
		if ( is_search() ) {
			...
			wp_localize_script(
				...
				array(
					...
					'i18n'           => array(
						'all'         => __( 'All', '6arshid-social-community-main' ),
						'activity'    => __( 'Activity', '6arshid-social-community-main' ),
						'members'     => __( 'People', '6arshid-social-community-main' ),
						'groups'      => __( 'Groups', '6arshid-social-community-main' ),
						'marketplace' => __( 'Marketplace', '6arshid-social-community-main' ),
						'search'      => __( 'Search', '6arshid-social-community-main' ),
						'noResults'   => __( 'No results found', '6arshid-social-community-main' ),
						'noResultsSub'=> __( 'Try a different keyword.', '6arshid-social-community-main' ),
						'seeAll'      => __( 'See all', '6arshid-social-community-main' ),
						'results'     => __( 'results', '6arshid-social-community-main' ),
						'loadMore'    => __( 'Load more', '6arshid-social-community-main' ),
						'loading'     => __( 'Loading…', '6arshid-social-community-main' ),
						'viewPost'    => __( 'View post', '6arshid-social-community-main' ),
						'free'        => __( 'Free', '6arshid-social-community-main' ),
						'members_lc'  => __( 'members', '6arshid-social-community-main' ),
						'prev'        => __( '← Prev', '6arshid-social-community-main' ),
						'next'        => __( 'Next →', '6arshid-social-community-main' ),
					),
				)
			);
		}
	...
	private function frontend_i18n(): array {
		return array(
			'loading'          => __( 'Loading…', '6arshid-social-community-main' ),
			'noResults'        => __( 'No results found.', '6arshid-social-community-main' ),
			'error'            => __( 'Something went wrong. Please try again.', '6arshid-social-community-main' ),
			'confirm'          => __( 'Are you sure?', '6arshid-social-community-main' ),
			'likeActivity'     => __( 'Like', '6arshid-social-community-main' ),
			'unlikeActivity'   => __( 'Unlike', '6arshid-social-community-main' ),
			'addFriend'        => __( 'Add Friend', '6arshid-social-community-main' ),
			'cancelRequest'    => __( 'Cancel Request', '6arshid-social-community-main' ),
			'follow'           => __( 'Follow', '6arshid-social-community-main' ),
			'unfollow'         => __( 'Unfollow', '6arshid-social-community-main' ),
			'sendMessage'      => __( 'Send Message', '6arshid-social-community-main' ),
			'report'           => __( 'Report', '6arshid-social-community-main' ),
			'block'            => __( 'Block User', '6arshid-social-community-main' ),
			'unblock'          => __( 'Unblock User', '6arshid-social-community-main' ),
			'deleteActivity'   => __( 'Delete', '6arshid-social-community-main' ),
			'seeMore'          => __( 'See more', '6arshid-social-community-main' ),
			'seeLess'          => __( 'See less', '6arshid-social-community-main' ),
			'comment'          => __( 'Comment', '6arshid-social-community-main' ),
			'comments'         => __( 'Comments', '6arshid-social-community-main' ),
			'writeComment'     => __( 'Write a comment…', '6arshid-social-community-main' ),
			'loadMore'         => __( 'Load More', '6arshid-social-community-main' ),
			'attachMedia'      => __( 'Attach media', '6arshid-social-community-main' ),
			'reply'            => __( 'Reply', '6arshid-social-community-main' ),
			'replyingTo'       => __( 'Replying to', '6arshid-social-community-main' ),
			'react'               => __( 'React', '6arshid-social-community-main' ),
			'allNotifications'    => __( 'See all notifications', '6arshid-social-community-main' ),
			'markAllRead'         => __( 'Mark all read', '6arshid-social-community-main' ),
			'markRead'            => __( 'Mark as read', '6arshid-social-community-main' ),
			'noNotifications'     => __( 'No notifications yet.', '6arshid-social-community-main' ),
			'delete'              => __( 'Delete', '6arshid-social-community-main' ),
			'justNow'          => __( 'just now', '6arshid-social-community-main' ),
			/* translators: %d: number of minutes */
			'minuteAgo'        => __( '%d minute ago', '6arshid-social-community-main' ),
			/* translators: %d: number of minutes */
			'minutesAgo'       => __( '%d minutes ago', '6arshid-social-community-main' ),
			/* translators: %d: number of hours */
			'hourAgo'          => __( '%d hour ago', '6arshid-social-community-main' ),
			/* translators: %d: number of hours */
			'hoursAgo'         => __( '%d hours ago', '6arshid-social-community-main' ),
			/* translators: %d: number of days */
			'dayAgo'           => __( '%d day ago', '6arshid-social-community-main' ),
			/* translators: %d: number of days */
			'daysAgo'          => __( '%d days ago', '6arshid-social-community-main' ),
			'feedTabAll'       => __( 'All', '6arshid-social-community-main' ),
			'feedTabFollow'    => __( 'Follow', '6arshid-social-community-main' ),
			'noFollowActivity' => __( 'No activity from users or hashtags you follow yet.', '6arshid-social-community-main' ),
			'logoutFirst'      => __( 'You are already logged in. Please log out first.', '6arshid-social-community-main' ),
			'privacyPublic'    => __( 'Public', '6arshid-social-community-main' ),
			'privacyFriends'   => __( 'Friends', '6arshid-social-community-main' ),
			'privacyPrivate'   => __( 'Only Me', '6arshid-social-community-main' ),
			'privacyPaid'        => __( 'Paid', '6arshid-social-community-main' ),
			'paidContent'        => __( 'Paid content', '6arshid-social-community-main' ),
			// translators: %s is the price or plan name required to unlock the content.
			'unlockFor'          => __( 'Unlock for %s', '6arshid-social-community-main' ),
			'loginToUnlock'      => __( 'Login to unlock', '6arshid-social-community-main' ),
			'payNow'             => __( 'Pay now', '6arshid-social-community-main' ),
			'paymentProcessing'  => __( 'Payment confirmed! Unlocking…', '6arshid-social-community-main' ),
			'paymentFailed'      => __( 'Payment failed. Please try again.', '6arshid-social-community-main' ),
		);
	}
	...
	private function admin_i18n(): array {
		return array(
			'saved'           => __( 'Settings saved.', '6arshid-social-community-main' ),
			'error'           => __( 'Error saving settings.', '6arshid-social-community-main' ),
			'confirm'         => __( 'Are you sure?', '6arshid-social-community-main' ),
			'suspended'       => __( 'User suspended.', '6arshid-social-community-main' ),
			'unsuspended'     => __( 'User unsuspended.', '6arshid-social-community-main' ),
			'approved'        => __( 'Content approved.', '6arshid-social-community-main' ),
			'deleted'         => __( 'Item deleted.', '6arshid-social-community-main' ),
			'selectReason'    => __( 'Please select a reason.', '6arshid-social-community-main' ),
			'suspendUser'     => __( 'Suspend user', '6arshid-social-community-main' ),
			/* translators: %s: user name */
			'suspendConfirm'  => __( 'Suspend %s?', '6arshid-social-community-main' ),
			/* translators: %s: user name */
			'unsuspendConfirm' => __( 'Unsuspend %s?', '6arshid-social-community-main' ),
		);
	}
}
