	...
	public function enqueue_assets(): void {
		...
		if ( Engagement_Settings::enabled( 'social_share_external' ) ) {
			...
			$localize_data['extShare'] = array(
				...
				'i18n'       => array(
					...
					'shareTitle'     => __( 'Share this post', '6arshid-social-community-main' ),
					'shareTo'        => __( 'Share to', '6arshid-social-community-main' ),
					'search'         => __( 'Search networks…', '6arshid-social-community-main' ),
					'close'          => __( 'Close', '6arshid-social-community-main' ),
					'copied'         => __( 'Link copied!', '6arshid-social-community-main' ),
					'more'           => __( 'Show more networks', '6arshid-social-community-main' ),
					'sendAsMessage'  => __( 'Send as Message', '6arshid-social-community-main' ),
					'dmSearchPlaceholder' => __( 'Search users…', '6arshid-social-community-main' ),
					'dmSent'         => __( 'Message sent!', '6arshid-social-community-main' ),
					'dmError'        => __( 'Could not send message.', '6arshid-social-community-main' ),
					'dmLoginRequired' => __( 'You must be logged in to send messages.', '6arshid-social-community-main' ),
					'back'           => __( 'Back', '6arshid-social-community-main' ),
				),
			);
		}
		...
		if ( Engagement_Settings::enabled( 'social_embeds' ) ) {
			$localize_data['socialEmbeds'] = array(
				...
				'i18n'       => array(
					'dismissEmbed' => __( 'Remove embed preview', '6arshid-social-community-main' ),
					'loadEmbed'    => __( 'Click to load', '6arshid-social-community-main' ),
				),
			);
		}
