	...
	public static function networks(): array {
		return array(
			...
			'mastodon'         => array(
				'label' => 'Mastodon',
				'color' => '#6364ff',
				'url'   => 'https://toot.kytta.dev/?text={TITLE}%20{URL}',
			),
			'pinterest'        => array(
				'label' => 'Pinterest',
				'color' => '#e60023',
			...
			'messenger'        => array(
				'label' => 'Messenger',
				'color' => '#0084ff',
				'url'   => 'https://www.facebook.com/dialog/send?link={URL}&app_id=291494419107&redirect_uri={URL}',
			),
			'pocket'           => array(
				'label' => 'Pocket',
				'color' => '#ef3f56',
			...
			'buffer'           => array(
				'label' => 'Buffer',
				'color' => '#168de2',
				'url'   => 'https://buffer.com/add?url={URL}&title={TITLE}',
			),
			'trello'           => array(
				'label' => 'Trello',
				'color' => '#0052cc',
				'url'   => 'https://trello.com/add-card?source=mode&url={URL}&name={TITLE}',
			),
			'teams'            => array(
				'label' => 'Teams',
				'color' => '#6264a7',
				'url'   => 'https://teams.microsoft.com/share?href={URL}&msgText={TITLE}',
			),
			'hacker_news'      => array(
				'label' => 'Hacker News',
				'color' => '#ff6600',
			...
			'xing'             => array(
				'label' => 'XING',
				'color' => '#006567',
				'url'   => 'https://www.xing.com/spi/shares/new?sc_p=xing-share&url={URL}',
			),
			'mewe'             => array(
				'label' => 'MeWe',
				'color' => '#003399',
				'url'   => 'https://mewe.com/share?link={URL}',
			),
			'wordpress_com'    => array(
				'label' => 'WordPress',
				'color' => '#21759b',
			...
			'plurk'            => array(
				'label' => 'Plurk',
				'color' => '#cf682f',
				'url'   => 'https://www.plurk.com/?qualifier=shares&status={TITLE}%20{URL}',
			),
			'stocktwits'       => array(
				'label' => 'StockTwits',
				'color' => '#40a829',
				'url'   => 'https://stocktwits.com/transmit?body={TITLE}%20{URL}',
			),
			'blogger'          => array(
				'label' => 'Blogger',
				'color' => '#f57d00',
			...
			'typepad'          => array(
				'label' => 'TypePad',
				'color' => '#000000',
				'url'   => 'https://www.typepad.com/services/quickpost/create?qp_url={URL}&qp_title={TITLE}',
			),
			'diigo'            => array(
				'label' => 'Diigo',
				'color' => '#4da2dd',
				'url'   => 'https://www.diigo.com/post?url={URL}&title={TITLE}',
			),
			'livejournal'      => array(
				'label' => 'LiveJournal',
				'color' => '#00b0ea',
				'url'   => 'https://www.livejournal.com/update.bml?subject={TITLE}&event={URL}',
			),
			'mail_ru'          => array(
				'label' => 'Mail.Ru',
				'color' => '#005ff9',
				'url'   => 'https://connect.mail.ru/share?url={URL}&title={TITLE}',
			),
			'mendeley'         => array(
				'label' => 'Mendeley',
				'color' => '#a6001a',
				'url'   => 'https://www.mendeley.com/import/?url={URL}&title={TITLE}',
			),
			'meneame'          => array(
				'label' => 'Meneame',
				'color' => '#f16529',
			...
			'micro_blog'       => array(
				'label' => 'Micro.blog',
				'color' => '#eb8227',
				'url'   => 'https://micro.blog/?url={URL}&title={TITLE}',
			),
			'myspace'          => array(
				'label' => 'MySpace',
				'color' => '#313131',
			...
			'raindrop'         => array(
				'label' => 'Raindrop.io',
				'color' => '#0176d3',
				'url'   => 'https://app.raindrop.io/add?link={URL}&title={TITLE}',
			),
			'refind'           => array(
				'label' => 'Refind',
				'color' => '#1da1f2',
				'url'   => 'https://refind.com/add?url={URL}&title={TITLE}',
			),
			'folkd'            => array(
				'label' => 'Folkd',
				'color' => '#77bbff',
				'url'   => 'https://www.folkd.com/submit/{URL}',
			),
			'slashdot'         => array(
				'label' => 'Slashdot',
				'color' => '#000000',
				'url'   => 'https://slashdot.org/index.pl?op=newstory&url={URL}&title={TITLE}',
			),
			'svejo'            => array(
				'label' => 'Svejo',
				'color' => '#72b738',
				'url'   => 'https://svejo.net/add?url={URL}&title={TITLE}',
			),
			'symbaloo'         => array(
				'label' => 'Symbaloo',
				'color' => '#00a3e0',
				'url'   => 'https://www.symbaloo.com/add/tile?source=3&title={TITLE}&url={URL}',
			),
			'threema'          => array(
				'label'  => 'Threema',
				'color'  => '#4caf50',
				'url'    => 'https://threema.id/compose?text={TITLE}%20{URL}',
				'target' => '_self',
			),
			'wykop'            => array(
				'label' => 'Wykop',
				'color' => '#ff5917',
				'url'   => 'https://wykop.pl/dodaj/link/?url={URL}&title={TITLE}',
			),
			'yummly'           => array(
				'label' => 'Yummly',
				'color' => '#e6472a',
				'url'   => 'https://www.yummly.com/recipe/?url={URL}&title={TITLE}',
			),
			'douban'           => array(
				'label' => 'Douban',
				'color' => '#2ea131',
				'url'   => 'https://www.douban.com/recommend/?url={URL}&title={TITLE}',
			),
			'draugiem'         => array(
				'label' => 'Draugiem',
				'color' => '#ff6600',
			...
			'fark'             => array(
				'label' => 'Fark',
				'color' => '#000000',
				'url'   => 'https://cgi.fark.com/cgi/fark/submit.pl?new_url={URL}&new_comment={TITLE}',
			),
			...
			'google_translate' => array(
				...
				'color' => '#4285f4',
				'url'   => 'https://translate.google.com/translate?u={URL}',
			),
			'houzz'            => array(
				'label' => 'Houzz',
				'color' => '#7ac142',
				'url'   => 'https://www.houzz.com/imageClipperUpload?link={URL}&title={TITLE}',
			),
			'amazon_wishlist'  => array(
				'label' => 'Amazon Wish List',
				'color' => '#ff9900',
				'url'   => 'https://www.amazon.com/wishlist/add-to-cart?asin=&u={URL}',
			),
			'balatarin'        => array(
				'label' => 'Balatarin',
				'color' => '#1f5f8b',
				'url'   => 'https://www.balatarin.com/links/submit?url={URL}&title={TITLE}',
			),
			'bibsonomy'        => array(
				'label' => 'BibSonomy',
				'color' => '#6c6c6c',
				'url'   => 'https://www.bibsonomy.org/BibtexHandler?requTask=upload&url={URL}&description={TITLE}',
			),
			'blogmarks'        => array(
				'label' => 'BlogMarks',
				'color' => '#7c3a8e',
				'url'   => 'https://blogmarks.net/my/new.php?mini=1&url={URL}&title={TITLE}',
			),
			'bookmarks_fr'     => array(
				'label' => 'Bookmarks.fr',
				'color' => '#0c63a2',
				'url'   => 'https://www.bookmarks.fr/index.php?action=addlink&burl={URL}&btitle={TITLE}',
			),
			'box_net'          => array(
				'label' => 'Box.net',
				'color' => '#0061d5',
				'url'   => 'https://app.box.com/index.php?rm=box_v2_widget_thirdparty_sidebar&url={URL}',
			),
			'diary_ru'         => array(
				'label' => 'Diary.Ru',
				'color' => '#86bb5e',
				'url'   => 'https://www.diary.ru/?newpost&addurl&url={URL}&headline={TITLE}',
			),
			'known'            => array(
				'label' => 'Known',
				'color' => '#a67c52',
				'url'   => 'https://known.to/?url={URL}&title={TITLE}',
			),
			'mixi'             => array(
				'label' => 'Mixi',
				'color' => '#d1a72a',
				'url'   => 'https://mixi.jp/share.pl?u={URL}&t={TITLE}',
			),
			'papaly'           => array(
				'label' => 'Papaly',
				'color' => '#5ba7e0',
				'url'   => 'https://papaly.com/api/share/?url={URL}&title={TITLE}',
			),
			'print'            => array(
				'label'  => 'Print',
				'color'  => '#737373',
			...
			'printfriendly'    => array(
				'label' => 'PrintFriendly',
				'color' => '#009b00',
				'url'   => 'https://www.printfriendly.com/print?url={URL}',
			),
			'pusha'            => array(
				'label' => 'Pusha',
				'color' => '#000000',
				'url'   => 'https://pusha.se/pushitreal?url={URL}&title={TITLE}',
			),
			'push_to_kindle'   => array(
				'label' => 'Push to Kindle',
				'color' => '#333333',
				'url'   => 'https://fivefilters.org/kindle-it/send.php?url={URL}',
			),
			'rediff'           => array(
				'label' => 'Rediff MyPage',
				'color' => '#e53e3e',
				'url'   => 'https://bookmarks.rediff.com/bookmarks/bookmarks.rediffaddbookmark?newURL={URL}&Title={TITLE}',
			),
			'sitejot'          => array(
				'label' => 'SiteJot',
				'color' => '#ffa500',
				'url'   => 'https://www.sitejot.com/bookmark.sfly?action=add&url={URL}&title={TITLE}',
			),
			'twiddla'          => array(
				'label' => 'Twiddla',
				'color' => '#000000',
				'url'   => 'https://www.twiddla.com/CreateMeeting.aspx?meetingURL={URL}&meetingTitle={TITLE}',
			),
			'wechat'           => array(
				'label'  => 'WeChat',
				'color'  => '#07c160',
