...
class Social_Embeds_Renderer {
	...
	private static function lazy_wrap(
		...
		$btn_label = $prov_name
			...
			? sprintf( esc_attr__( 'Load %s embed', '6arshid-social-community-main' ), $prov_name )
			: esc_attr__( 'Load embed', '6arshid-social-community-main' );

		$click_label = $prov_name
			/* translators: %s: embed provider name */
			? sprintf( esc_html__( 'Click to load %s', '6arshid-social-community-main' ), $prov_name )
			: esc_html__( 'Click to load', '6arshid-social-community-main' );
		...
		$meta = '<div class="arshid6social-embed-meta">'
			...
			. esc_html__( 'View original', '6arshid-social-community-main' )
			. '</a>'
			. '</div>';
