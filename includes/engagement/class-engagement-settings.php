...
class Engagement_Settings {
	...
	public function __construct() {
		self::$features = array(
			'hashtags'             => __( 'Hashtags', '6arshid-social-community' ),
			'tag_friends'          => __( 'Tag Friends / @Mentions', '6arshid-social-community' ),
			'bookmarks'            => __( 'Bookmarks', '6arshid-social-community' ),
			'sticky_posts'         => __( 'Sticky Posts', '6arshid-social-community' ),
			'share_posts'          => __( 'Share / Repost', '6arshid-social-community' ),
			'polls'                => __( 'Polls', '6arshid-social-community' ),
			'advanced_polls'       => __( 'Advanced Polls', '6arshid-social-community' ),
			'comments_gifs'        => __( 'GIFs in Comments', '6arshid-social-community' ),
			'comments_attachments' => __( 'Comment Attachments', '6arshid-social-community' ),
	...
	public function add_tab( array $tabs ): array {
		$tabs['engagement'] = __( 'Engagement', '6arshid-social-community' );
		return $tabs;
	}
	...
	public function render(): void {
		...
		<p class="description"><?php esc_html_e( 'Toggle each feature independently. Disabled features unload all their hooks, REST routes, and assets.', '6arshid-social-community' ); ?></p>
	...
	private function render_social_embeds(): void {
		...
		<div class="arshid6social-eng-section">
			<h3><?php esc_html_e( 'Social Embeds', '6arshid-social-community' ); ?></h3>
			<p class="description"><?php esc_html_e( 'Auto-embed links from popular platforms when a supported URL is pasted into a post, comment, or message.', '6arshid-social-community' ); ?></p>

			<?php $this->toggle( 'arshid6social_eng_social_embeds', __( 'Enable Social Embeds', '6arshid-social-community' ) ); ?>

			<div class="arshid6social-eng-sub">

				<!-- Per-platform checkboxes -->
				<p><strong><?php esc_html_e( 'Enabled platforms:', '6arshid-social-community' ); ?></strong></p>
				<div style="display:flex;gap:6px;margin-bottom:10px;">
					<button type="button" class="button button-small arshid6social-embed-toggle-all" data-state="1"><?php esc_html_e( 'Enable all', '6arshid-social-community' ); ?></button>
					<button type="button" class="button button-small arshid6social-embed-toggle-all" data-state="0"><?php esc_html_e( 'Disable all', '6arshid-social-community' ); ?></button>
				</div>
				...
				<p style="margin-top:12px;"><strong><?php esc_html_e( 'Facebook & Instagram (official oEmbed):', '6arshid-social-community' ); ?></strong><br>
				<span class="description"><?php esc_html_e( 'Without tokens, both fall back to Open Graph preview automatically.', '6arshid-social-community' ); ?></span></p>
				<table class="form-table" style="margin:0;">
					<tr>
						<td style="padding:4px 0;"><label for="arshid6social_eng_embed_fb_token"><?php esc_html_e( 'Facebook App Token:', '6arshid-social-community' ); ?></label></td>
					...
					<tr>
						<td style="padding:4px 0;"><label for="arshid6social_eng_embed_ig_token"><?php esc_html_e( 'Instagram Access Token:', '6arshid-social-community' ); ?></label></td>
				...
				<!-- Allowed locations -->
				<p style="margin-top:14px;"><strong><?php esc_html_e( 'Embed in:', '6arshid-social-community' ); ?></strong></p>
				<?php
				$loc_options = array(
					'activity' => __( 'Activity posts', '6arshid-social-community' ),
				...
				<!-- Behaviour options -->
				<p style="margin-top:14px;"><strong><?php esc_html_e( 'Behaviour:', '6arshid-social-community' ); ?></strong></p>
				<label style="display:block;margin-bottom:6px;">
					<?php esc_html_e( 'Max embeds per content item:', '6arshid-social-community' ); ?>
				...
				<label style="display:block;margin-bottom:6px;">
					<?php esc_html_e( 'Cache duration (hours):', '6arshid-social-community' ); ?>
				...
				<label style="display:block;margin-bottom:6px;">
					...
					<?php esc_html_e( 'Lazy / click-to-load (privacy-first: no third-party request until user clicks)', '6arshid-social-community' ); ?>
				</label>
				<label style="display:block;margin-bottom:6px;">
					...
					<?php esc_html_e( 'Strip tracking parameters from URLs (utm_*, fbclid, etc.) before embedding', '6arshid-social-community' ); ?>
				</label>
				<label style="display:block;margin-bottom:6px;">
					...
					<?php esc_html_e( 'Fallback to Open Graph preview card when a provider fails', '6arshid-social-community' ); ?>
				</label>
				<label style="display:block;margin-bottom:6px;">
					...
					<?php esc_html_e( 'Show Open Graph preview for any URL that doesn\'t match a specific provider', '6arshid-social-community' ); ?>
				</label>

				<!-- Banned domains -->
				<p style="margin-top:12px;"><strong><?php esc_html_e( 'Blocked domains (one per line):', '6arshid-social-community' ); ?></strong><br>
				<span class="description"><?php esc_html_e( 'URLs from these domains will never be embedded.', '6arshid-social-community' ); ?></span></p>
	...
	private function render_hashtags(): void {
		?>
		<div class="arshid6social-eng-section">
			<h3><?php esc_html_e( 'Hashtags', '6arshid-social-community' ); ?></h3>
			<?php $this->toggle( 'arshid6social_eng_hashtags', __( 'Enable Hashtags', '6arshid-social-community' ) ); ?>
			<div class="arshid6social-eng-sub">
				<label>
					<?php esc_html_e( 'Banned hashtags (one per line):', '6arshid-social-community' ); ?><br>
	...
	private function render_tag_friends(): void {
		?>
		<div class="arshid6social-eng-section">
			<h3><?php esc_html_e( 'Tag Friends / @Mentions', '6arshid-social-community' ); ?></h3>
			<?php $this->toggle( 'arshid6social_eng_tag_friends', __( 'Enable Tag Friends', '6arshid-social-community' ) ); ?>
			<div class="arshid6social-eng-sub">
				<label>
					...
					<?php esc_html_e( 'Allow photo hotspot tagging', '6arshid-social-community' ); ?>
				</label>
				<label>
					<input type="checkbox" name="arshid6social_eng_tag_review" value="1"
						<?php checked( get_option( 'arshid6social_eng_tag_review', false ) ); ?> />
					<?php esc_html_e( 'Require tag approval before appearing on profile', '6arshid-social-community' ); ?>
				</label>
				<label>
					<?php esc_html_e( 'Default taggability:', '6arshid-social-community' ); ?>
	...
	private function render_bookmarks(): void {
		?>
		<div class="arshid6social-eng-section">
			<h3><?php esc_html_e( 'Bookmarks', '6arshid-social-community' ); ?></h3>
			<?php $this->toggle( 'arshid6social_eng_bookmarks', __( 'Enable Bookmarks', '6arshid-social-community' ) ); ?>
			<div class="arshid6social-eng-sub">
				<label>
					...
					<?php esc_html_e( 'Allow named collections/folders', '6arshid-social-community' ); ?>
				</label>
			</div>
		</div>
		<?php
	...
	private function render_sticky_posts(): void {
		?>
		<div class="arshid6social-eng-section">
			<h3><?php esc_html_e( 'Sticky Posts', '6arshid-social-community' ); ?></h3>
			<?php $this->toggle( 'arshid6social_eng_sticky_posts', __( 'Enable Sticky Posts', '6arshid-social-community' ) ); ?>
			<div class="arshid6social-eng-sub">
				<label>
					...
					<?php esc_html_e( 'Allow multiple site-wide sticky posts at once', '6arshid-social-community' ); ?>
				</label>
			</div>
		</div>
		<?php
	...
	private function render_share_posts(): void {
		?>
		<div class="arshid6social-eng-section">
			<h3><?php esc_html_e( 'Share / Repost', '6arshid-social-community' ); ?></h3>
			<?php $this->toggle( 'arshid6social_eng_share_posts', __( 'Enable Share / Repost', '6arshid-social-community' ) ); ?>
			<div class="arshid6social-eng-sub">
				<label>
					...
					<?php esc_html_e( 'Enable external share buttons (X, Facebook, WhatsApp, Telegram)', '6arshid-social-community' ); ?>
				</label>
			</div>
		</div>
		<?php
	...
	private function render_polls(): void {
		?>
		<div class="arshid6social-eng-section">
			<h3><?php esc_html_e( 'Polls', '6arshid-social-community' ); ?></h3>
			<?php $this->toggle( 'arshid6social_eng_polls', __( 'Enable Polls', '6arshid-social-community' ) ); ?>
			<?php $this->toggle( 'arshid6social_eng_advanced_polls', __( 'Enable Advanced Polls (image polls, quiz mode, ranked choice, CSV export)', '6arshid-social-community' ) ); ?>
			<div class="arshid6social-eng-sub">
				<label>
					<?php esc_html_e( 'Max options per poll:', '6arshid-social-community' ); ?>
				...
				<label>
					...
					<?php esc_html_e( 'Allow voters to suggest new options (goes to moderation queue)', '6arshid-social-community' ); ?>
				</label>
			</div>
		</div>
		<?php
	...
	private function render_comments_gifs(): void {
		?>
		<div class="arshid6social-eng-section">
			<h3><?php esc_html_e( 'GIFs in Comments &amp; Messages', '6arshid-social-community' ); ?></h3>
			<?php $this->toggle( 'arshid6social_eng_comments_gifs', __( 'Enable GIF Picker', '6arshid-social-community' ) ); ?>
			<div class="arshid6social-eng-sub">
				<label>
					<?php esc_html_e( 'GIPHY API Key:', '6arshid-social-community' ); ?>
				...
				<label>
					...
					<?php esc_html_e( 'Cache GIF URLs locally (saves bandwidth)', '6arshid-social-community' ); ?>
				</label>
			</div>
		</div>
		<?php
	...
	private function render_comments_attachments(): void {
		...
		?>
		<div class="arshid6social-eng-section">
			<h3><?php esc_html_e( 'Comment Attachments', '6arshid-social-community' ); ?></h3>
			<?php $this->toggle( 'arshid6social_eng_comments_attachments', __( 'Allow file attachments in comments', '6arshid-social-community' ) ); ?>
			<div class="arshid6social-eng-sub">
				<label>
					<?php esc_html_e( 'Max size per file (MB):', '6arshid-social-community' ); ?>
	...
	private function render_messages_attachments(): void {
		...
		?>
		<div class="arshid6social-eng-section">
			<h3><?php esc_html_e( 'Message Attachments', '6arshid-social-community' ); ?></h3>
			<?php $this->toggle( 'arshid6social_eng_messages_attachments', __( 'Allow file attachments in messages', '6arshid-social-community' ) ); ?>
			<div class="arshid6social-eng-sub">
				<label>
					<?php esc_html_e( 'Max size per file (MB):', '6arshid-social-community' ); ?>
	...
	private function render_social_share_external(): void {
		...
		<div class="arshid6social-eng-section">
			...
			<div class="arshid6social-eng-sub">
				...
				<p>
					<strong><?php esc_html_e( 'Networks:', '6arshid-social-community' ); ?></strong>
					<span class="description">
						<?php esc_html_e( 'Check to enable · drag ⠿ to reorder · order is reflected in the share modal.', '6arshid-social-community' ); ?>
					</span>
				</p>
				<ul id="arshid6social-sn-net-list" style="display:flex;flex-wrap:wrap;gap:5px;margin:6px 0 14px;padding:0;list-style:none;">
					...
					<li class="arshid6social-sn-net-item" data-network="<?php echo esc_attr( $key ); ?>"
						...
						<span class="arshid6social-sn-drag-handle" title="<?php esc_attr_e( 'Drag to reorder', '6arshid-social-community' ); ?>"
				...
				<!-- Max visible -->
				<label style="display:flex;align-items:center;gap:8px;margin-bottom:8px;">
					<strong><?php esc_html_e( 'Visible networks before "More…":', '6arshid-social-community' ); ?></strong>
					...
					<span class="description"><?php esc_html_e( '(0 = show all)', '6arshid-social-community' ); ?></span>
				</label>
				...
				<label style="display:inline-flex;align-items:center;gap:6px;">
					...
					<?php esc_html_e( 'Use native share sheet on mobile (iOS/Android)', '6arshid-social-community' ); ?>
				</label>
