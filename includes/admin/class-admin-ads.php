...
final class Admin_Ads {
	...
	private function render_list(): void {
		...
		(function(){
			...
			var confirmTxt = '<?php echo esc_js( __( 'Delete this ad?', '6arshid social community' ) ); ?>';
	...
	private function render_form( int $ad_id ): void {
		...
		(function(){
			...
			var nonce      = '<?php echo esc_js( $nonce ); ?>';
			var uploadErr  = '<?php echo esc_js( __( 'Upload failed. Please try again.', '6arshid social community' ) ); ?>';
			...
			fileInput.addEventListener('change', function(){
				...
				statusSpan.textContent = '<?php echo esc_js( __( 'Uploading…', '6arshid social community' ) ); ?>';
