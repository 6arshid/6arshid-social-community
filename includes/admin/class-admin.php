...
final class Admin {
	...
	public function register_menus(): void {
		add_menu_page(
			__( '6arshid-social-community-main', '6arshid-social-community-main' ),
			__( '6arshid-social-community-main', '6arshid-social-community-main' ),
		...
		add_submenu_page(
			'arshid6social-dashboard',
			__( 'Dashboard', '6arshid-social-community-main' ),
			__( 'Dashboard', '6arshid-social-community-main' ),
			'arshid6social_manage_settings',
			'arshid6social-dashboard',
			array( $this, 'render_dashboard' )
		...
		$activity_hook = add_submenu_page(
			'arshid6social-dashboard',
			__( 'Activity Items', '6arshid-social-community-main' ),
			__( 'Activity Items', '6arshid-social-community-main' ),
			'arshid6social_manage_settings',
		...
		$members_hook = add_submenu_page(
			'arshid6social-dashboard',
			__( 'Members', '6arshid-social-community-main' ),
			__( 'Members', '6arshid-social-community-main' ),
		...
		$moderation_hook = add_submenu_page(
			'arshid6social-dashboard',
			__( 'Reports & Moderation', '6arshid-social-community-main' ),
			__( 'Moderation', '6arshid-social-community-main' ),
		...
		if ( get_option( 'arshid6social_verification_enabled', false ) ) {
			$verification_hook = add_submenu_page(
				'arshid6social-dashboard',
				__( 'Verification Queue', '6arshid-social-community-main' ),
				__( 'Verification', '6arshid-social-community-main' ),
				'arshid6social_manage_members',
		...
		add_submenu_page(
			'arshid6social-dashboard',
			__( 'Pages & Shortcodes', '6arshid-social-community-main' ),
			__( 'Pages & Shortcodes', '6arshid-social-community-main' ),
			'arshid6social_manage_settings',
			'arshid6social-pages',
		...
		add_submenu_page(
			'arshid6social-dashboard',
			__( 'Notifications', '6arshid-social-community-main' ),
			__( 'Notifications', '6arshid-social-community-main' ),
			'arshid6social_manage_settings',
		...
		$mkt_hook = add_submenu_page(
			'arshid6social-dashboard',
			__( 'Products Archive', '6arshid-social-community-main' ),
			__( 'Products Archive', '6arshid-social-community-main' ),
			'arshid6social_manage_settings',
		...
		add_submenu_page(
			'arshid6social-dashboard',
			__( 'Ads Manager', '6arshid-social-community-main' ),
			__( 'Ads Manager', '6arshid-social-community-main' ),
			'arshid6social_manage_settings',
			'arshid6social-ads',
		...
		$monetization_hook = add_submenu_page(
			'arshid6social-dashboard',
			__( 'Monetization', '6arshid-social-community-main' ),
			__( 'Monetization', '6arshid-social-community-main' ),
			'arshid6social_manage_settings',
		...
		add_submenu_page(
			'arshid6social-dashboard',
			__( 'Settings', '6arshid-social-community-main' ),
			__( 'Settings', '6arshid-social-community-main' ),
			'arshid6social_manage_settings',
	...
	public function render_dashboard(): void {
		...
		echo '<h1>' . esc_html__( '6Arshid Social Community Dashboard', '6arshid-social-community-main' ) . '</h1>';

		$card_defs = array(
			array(
				'label'  => __( 'Activity Items', '6arshid-social-community-main' ),
				'count'  => $stats['activity'],
				'icon'   => 'dashicons-format-status',
				'url'    => admin_url( 'admin.php?page=arshid6social-activity' ),
			),
			array(
				'label'  => __( 'Groups', '6arshid-social-community-main' ),
				'count'  => $stats['groups'],
				'icon'   => 'dashicons-groups',
				'url'    => admin_url( 'admin.php?page=arshid6social-moderation' ),
			),
			array(
				'label'  => __( 'Members', '6arshid-social-community-main' ),
				'count'  => $stats['members'],
				'icon'   => 'dashicons-admin-users',
				'url'    => admin_url( 'admin.php?page=arshid6social-members' ),
			),
			array(
				'label'  => __( 'Pending Reports', '6arshid-social-community-main' ),
				'count'  => $stats['reports'],
				'icon'   => 'dashicons-flag',
				'url'    => admin_url( 'admin.php?page=arshid6social-moderation' ),
			),
			array(
				'label'  => __( 'Products Archive', '6arshid-social-community-main' ),
		...
		if ( get_option( 'arshid6social_verification_enabled', false ) ) {
			$card_defs[] = array(
				'label'  => __( 'Pending Verifications', '6arshid-social-community-main' ),
	...
	public function maybe_show_setup_notice(): void {
		...
		if ( get_transient( 'arshid6social_setup_redirect' ) ) {
			...
			printf(
				...
				esc_html__( 'Welcome to 6Arshid Social Community!', '6arshid-social-community-main' ),
				esc_url( admin_url( 'index.php?page=arshid6social-setup' ) ),
				esc_html__( 'Run the setup wizard →', '6arshid-social-community-main' )
			);
		}
		...
		if ( $missing ) {
			printf(
				...
				esc_html__( '6Arshid Social Community: Some required pages are missing.', '6arshid-social-community-main' ),
				...
				esc_html__( 'Click here to create them automatically →', '6arshid-social-community-main' )
			);
		}
	}
	...
	public function plugin_action_links( array $links ): array {
		$links['settings'] = sprintf(
			...
			esc_html__( 'Settings', '6arshid-social-community-main' )
		);
		$links['pages'] = sprintf(
			'<a href="%s">%s</a>',
			esc_url( admin_url( 'admin.php?page=arshid6social-pages' ) ),
			esc_html__( 'Pages', '6arshid-social-community-main' )
		);
		return $links;
	}
	...
	public function setup_monetization_screen_options(): void {
		...
		if ( 'payouts' === $tab ) {
			add_screen_option( 'per_page', array(
				'label'   => __( 'IBANs per page', '6arshid-social-community-main' ),
				'default' => 20,
				'option'  => 'arshid6social_payouts_per_page',
			) );
		} elseif ( 'transactions' === $tab ) {
			add_screen_option( 'per_page', array(
				'label'   => __( 'Transactions per page', '6arshid-social-community-main' ),
				'default' => 25,
	...
	public function render_monetization(): void {
		...
		$tabs = array(
			'settings'     => __( 'Settings', '6arshid-social-community-main' ),
			'payouts'      => __( 'Creator Payouts — IBAN List', '6arshid-social-community-main' ),
			'transactions' => __( 'Financial Transactions', '6arshid-social-community-main' ),
		);

		echo '<div class="wrap arshid6social-admin-settings">';
		echo '<h1>' . esc_html__( 'Monetization', '6arshid-social-community-main' ) . '</h1>';
	...
	private function render_monetization_transactions_tab(): void {
		...
		if ( $wpdb->get_var( "SHOW TABLES LIKE '{$table}'" ) !== $table ) {
			echo '<p class="description">' . esc_html__( 'Transactions table does not exist yet. Enable Monetization and save settings first.', '6arshid-social-community-main' ) . '</p>';
			return;
		}
		...
		?>
		<h2 style="margin-top:0;"><?php esc_html_e( 'Financial Transactions', '6arshid-social-community-main' ); ?></h2>
		...
		<form method="get" style="display:flex;flex-wrap:wrap;gap:8px;margin-bottom:16px;align-items:center;">
			...
			<input type="search" name="s" value="<?php echo esc_attr( $search ); ?>"
				placeholder="<?php esc_attr_e( 'Name, email, gateway ref…', '6arshid-social-community-main' ); ?>"
			...
			<select name="txtype" style="padding:5px;border:1px solid #8c8f94;border-radius:4px;">
				<option value=""><?php esc_html_e( 'All types', '6arshid-social-community-main' ); ?></option>
			...
			<select name="txstatus" style="padding:5px;border:1px solid #8c8f94;border-radius:4px;">
				<option value=""><?php esc_html_e( 'All statuses', '6arshid-social-community-main' ); ?></option>
			...
			<?php submit_button( __( 'Filter', '6arshid-social-community-main' ), 'secondary', '', false, array( 'style' => 'padding:4px 12px;' ) ); ?>
			<?php if ( $search || $filter_type || $filter_status ) : ?>
				<a href="<?php echo esc_url( add_query_arg( array( 'page' => 'arshid6social-monetization', 'tab' => 'transactions' ), admin_url( 'admin.php' ) ) ); ?>" class="button"><?php esc_html_e( 'Clear', '6arshid-social-community-main' ); ?></a>
			<?php endif; ?>
		</form>
		...
		<p class="description" style="margin-bottom:8px;">
			...
			printf( esc_html__( '%d transaction(s) found.', '6arshid-social-community-main' ), (int) $total );
			?>
		</p>

		<?php if ( empty( $rows ) ) : ?>
			<p class="description" style="padding:1rem;background:#f6f7f7;border-radius:4px;">
				<?php esc_html_e( 'No transactions match the current filter.', '6arshid-social-community-main' ); ?>
			</p>
		<?php else : ?>
			<table class="widefat striped" style="margin-top:0;">
				<thead>
					<tr>
						<th>#</th>
						<th><?php esc_html_e( 'Type', '6arshid-social-community-main' ); ?></th>
						<th><?php esc_html_e( 'Payer', '6arshid-social-community-main' ); ?></th>
						<th><?php esc_html_e( 'Creator', '6arshid-social-community-main' ); ?></th>
						<th><?php esc_html_e( 'Amount', '6arshid-social-community-main' ); ?></th>
						<th><?php esc_html_e( 'Fee', '6arshid-social-community-main' ); ?></th>
						<th><?php esc_html_e( 'Status', '6arshid-social-community-main' ); ?></th>
						<th><?php esc_html_e( 'Gateway Ref', '6arshid-social-community-main' ); ?></th>
						<th><?php esc_html_e( 'Date', '6arshid-social-community-main' ); ?></th>
					</tr>
				</thead>
				<tbody>
