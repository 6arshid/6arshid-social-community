...
class Cache_Purge {
	...
	public static function admin_bar_button( \WP_Admin_Bar $bar ): void {
		...
		$bar->add_node( array(
			...
			'meta'  => array( 'title' => __( 'Purge all 6Arshid Social Community caches', 'social-network-6' ) ),
		) );
	}
	...
	public static function handle(): void {
		if ( ! current_user_can( 'manage_options' ) ) {
			wp_die( esc_html__( 'Not allowed.', 'social-network-6' ), 403 );
		}
	...
	public static function notice(): void {
		...
		echo '<div class="notice notice-success is-dismissible"><p>'
			. esc_html__( '6Arshid Social Community: all caches purged successfully.', 'social-network-6' )
			. '</p></div>';
	}
